...
local kq_goldenshrimp =
{
    test = function(cooker, names, tags)
        return (names.wobster_sheller_land or names.kq_shrimp or names.kq_cookedshrimp or names.kq_deadshrimp or names.kq_cookeddeadshrimp)
        and names.potato and names.petals and not tags.egg -- and not tags.inedible
    end,
