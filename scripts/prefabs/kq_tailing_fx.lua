...
local TEXTURE = resolvefilepath("images/kq_tailing.tex")
local SHADER = "shaders/vfx_particle.ksh"

local COLOUR_ENVELOPE_NAME = "kq_tailing_colourenvelope"
local SCALE_ENVELOPE_NAME = "kq_tailing_scaleenvelope"
...
local function InitEnvelope()
	...
	EnvelopeManager:AddColourEnvelope(COLOUR_ENVELOPE_NAME .. 0, {
		{ 0, IntColour(123, 104, 238, 255) },
		{ 0.5, IntColour(123, 104, 238, 255) },
		{ 1, IntColour(123, 104, 238, 0) },
	})

	EnvelopeManager:AddColourEnvelope(COLOUR_ENVELOPE_NAME .. 1, {
		{ 0, IntColour(193, 163, 224, 255) },
		{ 0.5, IntColour(193, 163, 224, 255) },
		{ 1, IntColour(193, 163, 224, 0) },
	})

	EnvelopeManager:AddColourEnvelope(COLOUR_ENVELOPE_NAME .. 2, {
		{ 0, IntColour(255, 192, 203, 255) },
		{ 0.5, IntColour(255, 192, 203, 255) },
		{ 1, IntColour(255, 192, 203, 0) },
	})
...
local function emit_rose_fn(effect, i, spark_sphere_emitter)
	...
	effect:AddRotatingParticleUV(
		...
		vz, -- velocity
		angle,
		ang_vel, -- angle, angular_velocity
		uv_offset,
		0 -- uv offset
	)
end
...
local function fn()
	...
	for i = 0, num_emitters do
		...
		effect:SetMaxNumParticles(i, 75)
		...
		effect:SetDragCoefficient(i, 0.1)
	end
	-----------------------------------------------------
...
return Prefab("kq_tailing_fx", fn, assets)
