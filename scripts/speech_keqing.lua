return
{
	ACTIONFAIL =
	{
		...
		SHAVE =
		{
			AWAKEBEEFALO = "在它醒着时去弄是不礼貌的。",		--给醒着的牛刮毛
			GENERIC = "我不能给那个剃毛！",		--刮牛毛失败
			NOBITS = "已经刮过了。",		--不能给没毛的牛刮毛
			REFUSE = "only_used_by_woodie",		--拒绝刮胡子（伍迪专用）
			SOMEONEELSESBEEFALO = "我才不薅别人家皮弗娄牛的毛！",		--不能刮队友牛的毛
		},
		STORE =
		{
			GENERIC = "装满了。",		--存放东西失败
			NOTALLOWED = "这东西不能装进那里。",		--存放东西不被允许
			INUSE = "我应该遵守先后顺序。",		--别人正在用箱子
			NOTMASTERCHEF = "要我来露一手吗？",		--使用大厨厨具
		},
		CONSTRUCT =		--建造计划
		{
			INUSE = "有人抢先了。",		--建筑正在使用
			...
			MISMATCH = "啊，计划错误。",		--建造成果错误（未应用）
			NOTREADY = "情况稳定下来之后它可能会出现。",	--当前状态无法建造
		},
		RUMMAGE =	--打开或关闭容器
		{
			GENERIC = "我不能那么做。",		--打开箱子失败
			INUSE = "有人正在用。",		--不能打开箱子，别人正在使用
			NOTMASTERCHEF = "应该还不错吧。",		--使用大厨厨具
		},
		...
		{
			WRONGKEY = "这就是枫丹的年兽吗？",		--使用普通鹿角
			KLAUS = "克劳斯不是很友善啊。",		--克劳斯在场，无法打开
			QUAGMIRE_WRONGKEY = "我得再找一把钥匙。",	--（暴食）
		},
		ACTIVATE =	--激活
		{
			LOCKED_GATE = "大门锁上了。",		--大门锁住了（暴食）
			HOSTBUSY = "它现在好像有点忙。",		--良羽鸦正在忙
			CARNIVAL_HOST_HERE = "它就在附近。",		--良羽鸦已经在树旁
			NOCARNIVAL = "鸟儿看起来都飞走了。",		--良羽鸦已离开
			EMPTY_CATCOONDEN = "看起来小浣猫还没有收集到太多东西。",		--浣猫窝里没东西
			...
			MANNEQUIN_EQUIPSWAPFAILED = "它应该穿不上。",	--与假人互换装备失败
			PILLOWFIGHT_NO_HANDPILLOW = "我需要一个枕头来战斗！",	--没有枕头，无法进行枕头大战
			NOTMYBERNIE = "我的毛绒玩具没这么吓人。",	--无法安抚别人的伯尼
		},
		OPEN_CRAFTING =		--使用科技建筑
		{
			PROFESSIONALCHEF = "烹饪水平还不够。",		--非大厨角色使用便携厨具
			SHADOWMAGIC = "那可不是科学。",	--非老麦角色使用暗影秘典
		},
		COOK =
		{
		...
		DISMANTLE =		--收起便携厨具
		{
			...
			INUSE = "我应该等别人先用完。",		--无法收起，别人在用
			NOTEMPTY = "我得先把里面的东西拿出来。",		--厨具里有东西
		},
		FISH_OCEAN =	--海钓
		{
		...
		{
			GENERIC = "给不了。",		--给予失败
			DEAD = "也许我该先替他拿着。",		--给予失败，目标死亡
			SLEEPING = "睡得挺香。",		--给予失败，目标睡觉
			BUSY = "我应该等他把事情忙完。",		--给予失败，目标正忙
			ABIGAILHEART = "非常抱歉。",		--给阿比盖尔告密的心，无效
			GHOSTHEART = "或许，这不是好主意。",		--给鬼魂告密的心，无效
			NOTGEM = "我们应该用宝石试一下？",		--给的不是宝石
			WRONGGEM = "这个宝石在这里不起作用。",		--给错了宝石
			NOTSTAFF = "这个形状应该插一些法杖在里面。",		--给月石祭坛的物品不是法杖
			MUSHROOMFARM_NEEDSSHROOM = "给您添蘑菇了。",		--蘑菇农场需要先种蘑菇
			MUSHROOMFARM_NEEDSLOG = "一块活木头可能会有更多的用处。",		--蘑菇农场需要活木
			MUSHROOMFARM_NOMOONALLOWED = "农场根本承受不了这样的力量。",		--蘑菇农场无法种月光蘑菇
			SLOTFULL = "我们已经把一些东西放在那里了。",		--已经放了材料后，再给雕像桌子再给一个材料
			FOODFULL = "这儿已经有一顿饭了。",		--祭坛上已经有菜肴了（暴食）
			NOTDISH = "它肯定不想吃那个。",		--祭坛上不能摆非料理（暴食）
			DUPLICATE = "我们已经知道那个了。",		--给雕像桌子已经学习过的图纸
			NOTSCULPTABLE = "我们需要一些草图。",		--给陶艺圆盘的东西不对
			NOTATRIUMKEY = "它的形状有些不对。",		--远古大门钥匙不对
			CANTSHADOWREVIVE = "我们需要一些等待。。",		--远古大门冷却中
			WRONGSHADOWFORM = "造型上出了点小问题。",		--化石骨架形态错误，无法用心脏复活
			NOMOON = "或许这份力量需要月亮的帮助。",		--洞穴里无法使用天体传送门换人
			...
			TERRARIUM_REFUSE = "虽然不明白原理但是它好像需要噩梦燃料。",		--给泰拉瑞亚非噩梦燃料
		...
		GIVETOPLAYER =
		{
			FULL = "你可以试着留出一些空间。",		--给玩家一个东西，但是背包满了
			DEAD = "好吧。我先替你保管一下。",		--给死亡的玩家一个东西
			SLEEPING = "他正在休息呢。",		--给睡觉的玩家一个东西
			BUSY = "我马上再试试。",		--给忙碌的玩家一个东西
		},
		GIVEALLTOPLAYER =
		{
			FULL = "你可以试着留出更多空间。",		--给人一组东西，但是背包满了
			DEAD = "虽然有些多，我还是先帮你保管吧。",		--给于死去的玩家一组物品
			SLEEPING = "他正在休息呢。",		--给于正在睡觉的玩家一组物品
			BUSY = "我马上再试试。",		--给于正在忙碌的玩家一组物品
		},
		WRITE =
		{
			GENERIC = "我觉得它现在这样挺好。",		--写字失败
			INUSE = "只有能容纳一个涂鸦者的空间。",		--别人正在写字
		},
		DRAW =
		{
			NOIMAGE = "如果我面前有这东西，或许我能更顺利地画出来。",		--画图缺乏参照物
		},
		CHANGEIN =
		{
			GENERIC = "我现在不想换。",		--换装失败 
			BURNING = "我担心发生超载。",		--换装失败，衣柜着火了
			INUSE = "先不要打扰别人的换装了。。",		--衣橱有人占用
			NOTENOUGHHAIR = "皮毛不够用了。",		--皮弗娄牛美妆台上的牛被剃毛了
		...
		MOUNT =
		{
			TARGETINCOMBAT = "它现在有点暴躁！",		--骑乘失败，牛正在战斗
		...
		TEACH =
		{
			...
			STASH_MAP_NOT_FOUND = "没看到“X就是地点的标志”。大概是是忘记画了吧。",	--当前世界无法从海岛地图中读取到藏物处
		},
		WRAPBUNDLE =
		{
			EMPTY = "我需要一些东西来打包。",		--打包失败，打包纸里没有东西
		},
		PICKUP =
		{
			RESTRICTION = "技能不够熟练，用不了。",		--捡起错误的武器（熔炉）
			INUSE = "科学告诉我，我该等轮到我。",		--捡起对象的容器正在被别人打开
		...
		ROW_FAIL =		--划船失败
		{
			BAD_TIMING0 = "把握时机。",		--失败语句一
			BAD_TIMING1 = "机会稍纵即逝。",		--失败语句二
			BAD_TIMING2 = "专注一些。",		--失败语句三
		},
		...
		USEITEMON =
		{
			...
			BEEF_BELL_INVALID_TARGET = "它大概是对牛使用的。",		--牛铃只能对牛使用
	...
	ANNOUNCE_BEES = "是蜜蜂。",		--戴养蜂帽被蜜蜂蛰
	ANNOUNCE_BOOMERANG = "我大概需要一些练习。",		--没接住回旋镖
	ANNOUNCE_CHARLIE = "有人吗？",		--查理即将攻击
	ANNOUNCE_CHARLIE_ATTACK = "有些人不是很友善啊",		--被查理攻击
	ANNOUNCE_CHARLIE_MISSED = "哈！我知道你的所有招数！",	--winona specific	--挡住查理攻击
	ANNOUNCE_COLD = "我需要一个热源。",		--过冷
	ANNOUNCE_HOT = "需要一些冷源！",		--过热
	ANNOUNCE_CRAFTING_FAIL = "缺少一些关键成分。",		--未应用
	ANNOUNCE_DEERCLOPS = "走吧，时间紧迫。",		--boss来袭
	ANNOUNCE_CAVEIN = "有些地上的生物躁动不安了！",		--洞穴内蚁狮地震
	...
	ANNOUNCE_DUSK = "你最好在天黑之前找点吃的。。还有光源。",		--进入黄昏
	...
	{
		GENERIC = "还不错。",		--吃新鲜食物
		PAINFUL = "不能太过挑剔，对吧。",		--吃掉血食物
		SPOILED = "与理想中的味道有些差距。",		--吃红色食物及腐烂食物
		STALE = "虽然是为了节约，但还是尽量避免吧。",		--吃黄色食物
		INVALID = "这大概的确不能食用。",		--不可食用
		YUCKY = "它遵循着稻妻的理念。",		--拒绝食用恶心的东西（比如永恒的水果蛋糕）
	...
	{
		"我们应该远离这里！",		--中庭击杀织影者后开始震动，即将刷新
		"有什么东西要来力。",		--中庭击杀织影者后开始震动，即将刷新
		"这里不太安全。",		--中庭击杀织影者后开始震动，即将刷新
	},
	ANNOUNCE_RUINS_RESET = "怪物伴随着奖励一同归来了。",		--远古已重置
	ANNOUNCE_SNARED = "你困不住我的。",		--被远古织影者的骨笼困住
	ANNOUNCE_SNARED_IVY = "有些植物过于暴躁了。。",		--被刺针旋花的藤蔓困住
	ANNOUNCE_REPELLED = "我们需要解决一些机制。。",		--织影者进入保护状态
	ANNOUNCE_ENTER_DARK = "我们需要一些光源。",		--进入黑暗
	ANNOUNCE_ENTER_LIGHT = "啊。光明。",		--进入光源
	ANNOUNCE_FREEDOM = "我自由了！我终于自由了！",		--未应用（废案）
	ANNOUNCE_HIGHRESEARCH = "感觉我现在太聪明了！",		--未应用（废案）
	ANNOUNCE_HOUNDS = "有些猎犬的声音。",		--猎犬袭击即将到来
	ANNOUNCE_WORMS = "小心。它的伤害是一麦。",		--蠕虫袭击即将到来
	ANNOUNCE_HUNGRY = "需要一些补给。",		--饥饿
	ANNOUNCE_HUNT_BEAST_NEARBY = "痕迹还很新鲜，我们已经很接近了。",		--即将找到野兽
	ANNOUNCE_HUNT_LOST_TRAIL = "耽误太多时间，足迹可就找不到了。",		--脚印消失，追丢野兽
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "痕迹一旦被雨水冲刷干净，就很难再还原。",		--脚印消失，追丢野兽（潮湿天气）
	ANNOUNCE_HUNT_START_FORK = "有些危险的痕迹在里面。",	--摸脚印选带狗牙土堆
	ANNOUNCE_HUNT_SUCCESSFUL_FORK = "坚持的结果。",	--摸脚印结果导向丰盛收获
	ANNOUNCE_HUNT_WRONG_FORK = "这个痕迹有些危险。",	--摸脚印结果导向陷阱
	ANNOUNCE_HUNT_AVOID_FORK = "这个踪迹看起来安全多了。",	--摸脚印选普通土堆
	ANNOUNCE_INV_FULL = "可能我需要一个更大的背包？",		--身上的物品满了
	ANNOUNCE_KNOCKEDOUT = "大意了！",		--被催眠后醒来
	...
	ANNOUNCE_NODANGERGIFT = "先解决危险。",		--周围有危险的情况下打开礼物
	ANNOUNCE_NOMOUNTEDGIFT = "我得先从皮弗娄牛身上下来。",		--骑牛的时候打开礼物
	ANNOUNCE_NODANGERSLEEP = "你不能睡觉，周围有怪物在游荡。",		--周围危险，不能睡觉
	ANNOUNCE_NODAYSLEEP = "耽误太多时间，事情可就做不完了。",		--白天睡帐篷
	ANNOUNCE_NODAYSLEEP_CAVE = "无论是冒险还是做生意，机会都稍纵即逝。",		--洞穴里白天睡帐篷
	ANNOUNCE_NOHUNGERSLEEP = "在睡觉前我需要一些食物。",		--饿了无法睡觉
	ANNOUNCE_NOSLEEPONFIRE = "那里面有点危险。",		--帐篷着火无法睡觉
	ANNOUNCE_NOSLEEPHASPERMANENTLIGHT = "only_used_by_wx78",	--机器人安装发光模块时无法睡觉
	ANNOUNCE_NODANGERSIESTA = "现在午休太危险了。",		--周围危险，不能午睡
	ANNOUNCE_NONIGHTSIESTA = "一个帐篷才能保证你夜晚的安全。",		--夜晚睡凉棚
	ANNOUNCE_NONIGHTSIESTA_CAVE = "劳逸结合是不错，但别放松过头。",		--在洞穴里夜晚睡凉棚
	ANNOUNCE_NOHUNGERSIESTA = "一些食物是必要的。",		--饱食度不足无法午睡
	ANNOUNCE_NO_TRAP = "好吧，挺简单的。",		--没有陷阱（未应用）
	ANNOUNCE_PECKED = "噢！停下！",		--被小高脚鸟啄
	ANNOUNCE_QUAKE = "注意落石。",		--洞穴内地震
	ANNOUNCE_RESEARCH = "活到老学到老！",		--（未应用）
	ANNOUNCE_SHELTER = "想起了在外避雨的时候。",		--下雨天躲树下
	ANNOUNCE_THORNS = "有些扎手。",		--玫瑰、仙人掌、荆棘扎手
	ANNOUNCE_BURNT = "好烫！",		--扑灭冒烟的东西时被烫到
	ANNOUNCE_TORCH_OUT = "它燃尽了。",		--火把用完了
	ANNOUNCE_THURIBLE_OUT = "它消耗殆尽了。",		--暗影香炉燃尽
	ANNOUNCE_FAN_OUT = "风扇停了下来。",		--小风车停了
	ANNOUNCE_COMPASS_OUT = "这个指南针再也指不了方向了。",		--指南针用完了
	ANNOUNCE_TRAP_WENT_OFF = "啊。",		--触发陷阱（例如冬季陷阱）
	ANNOUNCE_UNIMPLEMENTED = "噢！这应该还没准备好。",		--（未应用）
	ANNOUNCE_WORMHOLE = "奇妙的旅行方式。",		--虫洞旅行
	ANNOUNCE_TOWNPORTALTELEPORT = "这是旅行者平时的赶路方式吗？",		--强征传送塔传送
	ANNOUNCE_CANFIX = "它看起来可以修好。",		--目标可以修理
	ANNOUNCE_ACCOMPLISHMENT = "我觉得好有成就感！",		--（未应用）
	ANNOUNCE_ACCOMPLISHMENT_DONE = "如果我的朋友现在能看到我就好了...",		--（未应用）
	ANNOUNCE_INSUFFICIENTFERTILIZER = "肥力不太够了。",		--土地肥力不足
	ANNOUNCE_TOOL_SLIP = "有些湿滑。",		--工具滑出
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "绝缘的衣物还是有用的。",		--绝缘，未被闪电击中
	ANNOUNCE_TOADESCAPING = "毒菌蟾蜍正在失去兴趣。",		--蟾蜍正在逃跑
	ANNOUNCE_TOADESCAPED = "毒菌蟾蜍逃走了。",		--蟾蜍逃走了


	ANNOUNCE_DAMP = "有点潮湿。",		--潮湿（1级）
	ANNOUNCE_WET = "工作要耽误了。。",		--潮湿（2级）
	ANNOUNCE_WETTER = "应该早点做些处理的。",		--潮湿（3级）
	ANNOUNCE_SOAKED = "真耽误事。",		--潮湿（4级）

	ANNOUNCE_WASHED_ASHORE = "衣服弄湿了，但是还活着。",		--淹水后飘回岸上

	ANNOUNCE_DESPAWN = "我的任务完成了。",		--天体传送门处换人
	ANNOUNCE_BECOMEGHOST = "呜呜呜呜呜！！",		--变成鬼魂
	ANNOUNCE_GHOSTDRAIN = "队友需要一些帮助。",		--队友死亡变成鬼魂掉san
	ANNOUNCE_PETRIFED_TREES = "这里的树也有石珀一样的性质吗。",		--树木石化了
	ANNOUNCE_KLAUS_ENRAGE = "看起来这位年兽并不太开心。。",		--杀死了鹿后克劳斯被激怒
	ANNOUNCE_KLAUS_UNCHAINED = "锁被打开了！",		--克劳斯第一次死亡后复活
	ANNOUNCE_KLAUS_CALLFORHELP = "它们看起来不是来送煤炭的。",		--克劳斯召唤小偷
	...
	--hallowed nights
	ANNOUNCE_SPOOKED = "蝙蝠？",		--被万圣节蝙蝠吓到
	ANNOUNCE_BRAVERY_POTION = "神奇的炼金术。树上的蝙蝠看起来老实多了。",		--喝下勇气药剂
	...
	ANNOUNCE_FLARE_SEEN = "是信号弹！",		--队友发出信号弹
	ANNOUNCE_MEGA_FLARE_SEEN = "谁会看到这个信号呢？",	--发出敌对信号弹
	...
	ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK	= "雷元素更充盈了。",		--获得料理buff：带电攻击
	ANNOUNCE_ATTACH_BUFF_ATTACK			= "速战速决！",		--获得料理buff：增加伤害
	ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "是你在保护我吗，帝君？",		--获得料理buff：增加防御
	ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "效率提升了。",		--获得料理buff：工作效率提高
	ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "不错的避雨效果。",		--获得料理buff：防潮湿
	ANNOUNCE_ATTACH_BUFF_SLEEPRESISTANCE   = "清醒多了！",		--获得料理buff：睡眠抗性

	ANNOUNCE_DETACH_BUFF_ELECTRICATTACK	= "没关系，我还有自己的雷元素。",		--料理buff消失：带电攻击
	ANNOUNCE_DETACH_BUFF_ATTACK			= "收工。",		--料理buff消失：增加伤害
	ANNOUNCE_DETACH_BUFF_PLAYERABSORPTION  = "这种时候帝君会怎么做呢。。",		--料理buff消失：增加防御
	ANNOUNCE_DETACH_BUFF_WORKEFFECTIVENESS = "我会继续加油的。",		--料理buff消失：工作效率提高
	...
	ANNOUNCE_OCEANFISHING_LINESNAP = "感觉不如。。直接炸鱼。",		--海钓竿断线
	...
	ANNOUNCE_WINCH_CLAW_NO_ITEM = "换个地方再试一次吧。",		--夹夹绞盘没捞到东西
	...
	ANNOUNCE_POCKETWATCH_PORTAL = "神奇的旅行装置。",		--从旺达的传送门里出来
	...
	ANNOUNCE_ARCHIVE_NEW_KNOWLEDGE = "神奇的异域知识。",		--学到知识饮水机的知识
	ANNOUNCE_ARCHIVE_OLD_KNOWLEDGE = "已经学过了。",		--学习已经学过的知识饮水机的知识
	ANNOUNCE_ARCHIVE_NO_POWER = "它用什么作能源？看上去元素力不管用。",		--档案馆能源未启动时尝试使用知识饮水机
	...
	ANNOUNCE_FERTILIZER_RESEARCHED = "好的肥料是田地的必需品。",		--研究新的肥料

	ANNOUNCE_FIRENETTLE_TOXIN =
	{
		"这株植物真是火元素充沛。。",		--吃下火荨麻后急剧升温
		"有点热过头了。",		--吃下火荨麻后急剧升温
	},
	ANNOUNCE_FIRENETTLE_TOXIN_DONE = "还是尽量避免接触这种植物吧。。",		--火荨麻升温效果结束
	...
	ANNOUNCE_TICOON_START_TRACKING	= "它捕捉到了气味！",		--大虎开始追踪
	ANNOUNCE_TICOON_NOTHING_TO_TRACK = "看来它什么都没找到。",		--大虎在此区域未发现小浣猫
	ANNOUNCE_TICOON_WAITING_FOR_LEADER = "我应该跟着它！",	--大虎在等待玩家
	ANNOUNCE_TICOON_GET_LEADER_ATTENTION = "他很想让我跟着。",		--大虎在呼叫玩家
	ANNOUNCE_TICOON_NEAR_KITCOON = "它一定是发现了什么！",		--大虎发现了小浣猫
	ANNOUNCE_TICOON_LOST_KITCOON = "看来别人找到了它要找的东西。",	--有人先一步发现了小浣猫
	ANNOUNCE_TICOON_ABANDONED = "我会自己找到那些小家伙的。",	--遗弃大虎
	ANNOUNCE_TICOON_DEAD = "可怜的家伙……它原本想把我带到哪里呢？",		--大虎死亡
	...
	-- AE4AE
	ANNOUNCE_EYEOFTERROR_ARRIVE = "它好像和我一样来自另一个世界。",	-- 新的眼球出现
	ANNOUNCE_EYEOFTERROR_FLYBACK = "这次不会再手下留情了！",				-- 没打完的眼球再次出现
	ANNOUNCE_EYEOFTERROR_FLYAWAY = "下次需要抓紧时间。",	-- 白天眼球逃走

	-- PIRATES
	ANNOUNCE_CANT_ESCAPE_CURSE = "这是来自坎瑞亚的诅咒吗？",	--诅咒饰品无法直接扔掉
	ANNOUNCE_MONKEY_CURSE_1 = "开始有芜猴的感觉了……",	--获得诅咒饰品，脚变成猴子脚
	ANNOUNCE_MONKEY_CURSE_CHANGE = "啊！",	--诅咒饰品到达堆叠上限后变成芜猴
	ANNOUNCE_MONKEY_CURSE_CHANGEBACK = "总算从猴身解脱了！",	--诅咒饰品全部去除，变回原样

	ANNOUNCE_PIRATES_ARRIVE = "是海盗的声音。",	--猴子海盗来临
	...
	--
	ANNOUNCE_TOOL_TOOWEAK = "质量和效率一样重要。",	--工具工作效率不够，无法使开裂的柱子振动
	...
	{
		GENERIC = "速战速决！",		--战斗
		PIG = "抱歉了，我的朋友。",		--与猪人战斗（疯猪除外）
		PREY = "无处可逃！",		--与小型生物战斗（例如兔子，青蛙，鼹鼠）
		SPIDER = "速战速决！",		--与蜘蛛战斗
		SPIDER_WARRIOR = "我是不会手下留情的！",		--与蜘蛛战士战斗
		DEER = "我需要你的角。",		--与无眼鹿战斗
	},
	COMBAT_QUIT =
	{
		GENERIC = "点到为止。",		--停止攻击
		PIG = "这次姑且放过他。",		--停止攻击猪人
		PREY = "它速度太快了！",		--停止攻击小型生物
		SPIDER = "不管怎么说，它真是太恶心了。",		--停止攻击蜘蛛
		SPIDER_WARRIOR = "嘘…你这个讨厌的家伙！",		--停止攻击蜘蛛战士
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "我是通过这扇门来到这里的吗？",		-- 物品名:"绚丽之门"
		MULTIPLAYER_PORTAL_MOONROCK = "有一些熟悉的来自天空的力量。。",		-- 物品名:"天体传送门"
		MOONROCKIDOL = "它有着神奇的力量。",		-- 物品名:"月岩雕像" 制造描述:"重要人物。"
		CONSTRUCTION_PLANS = "一次关于天空力量的尝试。",		-- 物品名:"建造计划"->升级绚丽之门至天体传送门
		...
		SANDSPIKE = "真危险。",		-- 物品名:"沙刺"
		SANDBLOCK = "真是坚持不懈！",		-- 物品名:"沙堡"
		GLASSSPIKE = "即使融化了也一样的危险。",		-- 物品名:"玻璃尖刺"
		GLASSBLOCK = "漂亮的工艺品。",		-- 物品名:"玻璃城堡"
		ABIGAIL_FLOWER =
		{
		...
		BALLOON = "它们怎么漂浮的？",		-- 物品名:"气球" 制造描述:"谁不喜欢气球呢？"
		...
		PLAYER =
		{
			...
			FIRESTARTER = "烧掉这个并不合适，%s。",		-- 物品名:"默认角色"->烧家
		},
		WILSON =
		{
		...
		GLOMMERWINGS = "非常抱歉，小飞虫。",		-- 物品名:"格罗姆翅膀"
		GLOMMERFUEL = "虽然恶心，但是看起来有治愈的效果。",		-- 物品名:"格罗姆的黏液"
		BELL = "叮呤呤。",		-- 物品名:"远古铃铛"（单机） 制造描述:"这可不是普通的铃铛。"
		STATUEGLOMMER =
		{
			GENERIC = "这是什么小飞虫的雕像吗？",		-- 物品名:"格罗姆雕像"->默认
			EMPTY = "真遗憾。",		-- 物品名:"格罗姆雕像"->被开采
		},

		LAVA_POND_ROCK = "这里的环境真是恶劣。",		-- 物品名:"岩石"（岩浆池边缘的石头）

		WEBBERSKULL = "可怜的小家伙。应该为他举办一个体面的葬礼。",		-- 物品名:"韦伯的头骨"
		WORMLIGHT = "看上去有点像流明石。",		-- 物品名:"发光浆果"
		WORMLIGHT_LESSER = "好吧，它失去了一些光亮。",		-- 物品名:"小发光浆果"
		WORM =
		{
			PLANT = "这是伤害为一麦的植物。",		-- 物品名:"洞穴蠕虫"->伪装成大光莓
			DIRT = "伺机而动。",		-- 物品名:"洞穴蠕虫"->潜伏在地下
			WORM = "小心。",		-- 物品名:"洞穴蠕虫"->钻出来了
		},
		WORMLIGHT_PLANT = "还算安全。",		-- 物品名:"神秘植物"（光莓）
		MOLE =
		{
		...
		SENTRYWARD = "不错的测绘工具。",		-- 物品名:"月眼守卫" 制造描述:"绘图者最有价值的武器。"
		TOWNPORTAL =
		{
		...
		MOONBASE =
		{
			GENERIC = "中间有个洞，可以放一些东西进去。",		-- 物品名:"月亮石"->默认
			BROKEN = "搞砸了。",		-- 物品名:"月亮石"->坏了
			STAFFED = "等待月圆吧。",		-- 物品名:"月亮石"->插上唤星者之杖
			WRONGSTAFF = "或许我们应该换一把法杖？",		-- 物品名:"月亮石"->插错法杖
			MOONSTAFF = "来自天上的能量点燃了它。",		-- 物品名:"月亮石"->已经插了法杖的（月杖）
		},
		MOONDIAL =
		{
			GENERIC = "简易的历法工具。",		-- 物品名:"月晷"->默认 制造描述:"追踪月相！"
			NIGHT_NEW = "是新月。",		-- 物品名:"月晷"->新月 制造描述:"追踪月相！"
			NIGHT_WAX = "是上弦月。",		-- 物品名:"月晷"->上弦月 制造描述:"追踪月相！"
			NIGHT_FULL = "是满月。也许我们应该钓鱼，或者去看一看月台？",		-- 物品名:"月晷"->满月 制造描述:"追踪月相！"
			NIGHT_WANE = "是下弦月",		-- 物品名:"月晷"->下弦月 制造描述:"追踪月相！"
			CAVE = "这里看不到天空。",		-- 物品名:"月晷"->洞穴 制造描述:"追踪月相！"
			WEREBEAVER = "only_used_by_woodie", --woodie specific		-- 物品名:"月晷"->洞穴海狸状态检查（伍迪专用） 制造描述:"追踪月相！"
			GLASSED = "我有种奇怪的感觉，有一道来自天空的视线。",		-- 物品名:"月晷"->月亮风暴 制造描述:"追踪月相！"
		},
		THULECITE = "铥，Tm。",		-- 物品名:"铥矿" 制造描述:"将小碎片合成一大块。"
		ARMORRUINS = "不错的防护措施。",		-- 物品名:"铥矿甲" 制造描述:"炫目并且能提供保护。"
		ARMORSKELETON = "铮铮白骨",		-- 物品名:"骨头盔甲"
		SKELETONHAT = "来自深渊的力量？",		-- 物品名:"骨头头盔"
		RUINS_BAT = "看上去有些魔法的力量蕴藏其中。",		-- 物品名:"铥矿棒" 制造描述:"尖钉让一切变得更好。"
		RUINSHAT = "旧时代的真神。",		-- 物品名:"铥矿皇冠" 制造描述:"附有远古力场！"
		NIGHTMARE_TIMEPIECE =
		{
			CALM = "一切都好了。",		-- 物品名:"铥矿徽章"->暴动结束 制造描述:"跟踪周围魔力水平的流动。"
			WARN = "感测到这里有相当强的深渊能量。",		-- 物品名:"铥矿徽章"->暴动开始 制造描述:"跟踪周围魔力水平的流动。"
			WAXING = "变得越来越密集了！",		-- 物品名:"铥矿徽章"->暴动加剧 制造描述:"跟踪周围魔力水平的流动。"
			STEADY = "好像保持稳定了。",		-- 物品名:"铥矿徽章"->暴动最猛烈 制造描述:"跟踪周围魔力水平的流动。"
			WANING = "感觉深渊能量正在逐渐减弱。",		-- 物品名:"铥矿徽章"->暴动减弱 制造描述:"跟踪周围魔力水平的流动。"
			DAWN = "噩梦就要结束了。",		-- 物品名:"铥矿徽章"->暴动即将结束 制造描述:"跟踪周围魔力水平的流动。"
			NOMAGIC = "这里没有深渊能量。",		-- 物品名:"铥矿徽章"->非远古区域 制造描述:"跟踪周围魔力水平的流动。"
		},
		BISHOP_NIGHTMARE = "是新种类的遗迹哨兵吗？",		-- 物品名:"损坏的发条主教"
		ROOK_NIGHTMARE = "有着不输遗迹守卫的破坏力。",		-- 物品名:"损坏的发条战车"
		KNIGHT_NIGHTMARE = "灵活的遗迹哨兵。",		-- 物品名:"损坏的发条骑士"
		MINOTAUR = "只有两条腿的犀牛？",		-- 物品名:"远古守护者"
		SPIDER_DROPPER = "似乎平时在洞穴天花板休憩。",		-- 物品名:"穴居悬蛛"
		NIGHTMARELIGHT = "古老的混沌机关。",		-- 物品名:"梦魇灯座"
		NIGHTSTICK = "自然的雷元素力量。",		-- 物品名:"晨星锤" 制造描述:"用于夜间战斗的晨光。"
		GREENGEM = "绿色的闪光中有着草元素的生命力。",		-- 物品名:"绿宝石"
		MULTITOOL_AXE_PICKAXE = "不错的工具。",		-- 物品名:"多用斧镐" 制造描述:"加倍实用。"
		ORANGESTAFF = "很明显，雷楔有着更高的效率。",		-- 物品名:"懒人魔杖" 制造描述:"适合那些不喜欢走路的人。"
		YELLOWAMULET = "不错的照明方式。",		-- 物品名:"魔光护符" 制造描述:"从天堂汲取力量。"
		GREENAMULET = "要是能把这种力量用于建设。。。不，没什么。",		-- 物品名:"建造护符" 制造描述:"用更少的材料合成物品！"
		SLURPERPELT = "死了的样子也没什么不同。",		-- 物品名:"啜食者皮"->啜食者皮

		SLURPER = "不要把它套在头上。",		-- 物品名:"啜食者"
		SLURPER_PELT = "死了的样子也没什么不同。",		-- 物品名:"啜食者皮"
		ARMORSLURPER = "一根湿漉漉的、帮助你抵抗饥饿的腰带。",		-- 物品名:"饥饿腰带" 制造描述:"保持肚子不饿。"
		ORANGEAMULET = "能省下很多时间。",		-- 物品名:"懒人护符" 制造描述:"适合那些不喜欢捡东西的人。"
		YELLOWSTAFF = "天空的力量，诸多元素在其中混杂。",		-- 物品名:"唤星者魔杖" 制造描述:"召唤一个小星星。"
		YELLOWGEM = "黄色的闪光，有着雷电一样的光芒能量。",		-- 物品名:"黄宝石"
		ORANGEGEM = "一颗橙色的，带着岩元素力量的宝石。",		-- 物品名:"橙宝石"
		OPALSTAFF = "简易的元素引导装置。",		-- 物品名:"唤月者魔杖"
		OPALPRECIOUSGEM = "这种特性是扩散？还是侵蚀？",		-- 物品名:"彩虹宝石"
		TELEBASE =
		{
		...
		STAFFLIGHT = "温暖，舒适。",		-- 物品名:"矮星"
		STAFFCOLDLIGHT = "美丽的光辉。",		-- 物品名:"极光"

		ANCIENT_ALTAR = "古老而神秘的建筑。",		-- 物品名:"远古伪科学站"

		ANCIENT_ALTAR_BROKEN = "它需要一些铥矿。",		-- 物品名:"损坏的远古伪科学站"

		ANCIENT_STATUE = "这让我想起了盐之魔神的传说。",		-- 物品名:"远古雕像"

		LICHEN = "只有蓝藻能在这种光线条件下生长。",		-- 物品名:"洞穴苔藓"->植物状态
		CUTLICHEN = "有营养，但腐坏太快了。",		-- 物品名:"苔藓"->物品

		CAVE_BANANA = "软塌塌的。",		-- 物品名:"洞穴香蕉"
		CAVE_BANANA_COOKED = "不错的零食。",		-- 物品名:"烤香蕉"
		CAVE_BANANA_TREE = "没有树叶的树？",		-- 物品名:"洞穴香蕉树"
		ROCKY = "不要把它带到地面上！",		-- 物品名:"石虾"
		...
		ARMORSNURTLESHELL = "完美的防护。",		-- 物品名:"蜗壳护甲"
		BAT = "不堪一击。",		-- 物品名:"洞穴蝙蝠"
		BATBAT = "理智换来生命。。我越来越相信这是深渊的力量了。",		-- 物品名:"蝙蝠棒" 制造描述:"所有科技都如此...耗费精神。"
		BATWING = "至少能用来做唱片。",		-- 物品名:"洞穴蝙蝠翅膀"
		BATWING_COOKED = "至少它不会再活过来了。",		-- 物品名:"烤蝙蝠翅膀"
		BATCAVE = "我可不想吵醒它们。",		-- 物品名:"蝙蝠洞"
		BEDROLL_FURRY = "暖和又舒服。",		-- 物品名:"毛皮铺盖" 制造描述:"舒适地一觉睡到天亮！"
		BUNNYMAN = "这里的环境竟然能让兔子长到这样的大小。",		-- 物品名:"兔人"
		FLOWER_CAVE = "不错的光源。",		-- 物品名:"荧光花"
		GUANO = "肥力更充足的粪便。",		-- 物品名:"鸟粪"
		LANTERN = "更文明的灯具。",		-- 物品名:"提灯" 制造描述:"可加燃料、明亮、便携！"
		LIGHTBULB = "不错的光源与燃料。",		-- 物品名:"荧光果"
		MANRABBIT_TAIL = "毛绒绒的，真舒服！",		-- 物品名:"兔绒"
		MUSHROOMHAT = "有点像须弥的蕈兽？",		-- 物品名:"蘑菇帽"
		MUSHROOM_LIGHT2 =
		{
			ON = "为了光明，辛苦是值得的。",		-- 物品名:"菌伞灯"->开启 制造描述:"受到火山岩浆灯饰学问的激发。"
			OFF = "我们可以用一些主要颜色来生成一个主要光源。",		-- 物品名:"菌伞灯"->关闭 制造描述:"受到火山岩浆灯饰学问的激发。"
			BURNT = "真遗憾。",		-- 物品名:"菌伞灯"->烧焦的 制造描述:"受到火山岩浆灯饰学问的激发。"
		},
		MUSHROOM_LIGHT =
		{
			ON = "不错的光明。",		-- 物品名:"蘑菇灯"->开启 制造描述:"任何蘑菇的完美添加物。"
			OFF = "有点像在层岩巨渊的微光。",		-- 物品名:"蘑菇灯"->关闭 制造描述:"任何蘑菇的完美添加物。"
			BURNT = "完全烧焦了。",		-- 物品名:"蘑菇灯"->烧焦的 制造描述:"任何蘑菇的完美添加物。"
		},
		SLEEPBOMB = "一扔就让我犯困。",		-- 物品名:"睡袋" 制造描述:"可以扔掉的袋子睡意沉沉。"
		MUSHROOMBOMB = "一朵蘑菇云正在生成！",		-- 物品名:"炸弹蘑菇"->蛤蟆战斗时种出来的炸弹
		SHROOM_SKIN = "真是皮糙肉厚。",		-- 物品名:"蘑菇皮"
		TOADSTOOL_CAP =
		{
			EMPTY = "只是地上的一个洞。",		-- 物品名:"毒菌蟾蜍"->蘑菇状态，冷却中
			INGROUND = "巨大的蘑菇。",		-- 物品名:"毒菌蟾蜍"->蘑菇状态，在地里面
			GENERIC = "那毒菌只是想被砍掉。",		-- 物品名:"毒菌蟾蜍"->蘑菇状态，默认
		},
		TOADSTOOL =
		{
			GENERIC = "有些大的过头了。",		-- 物品名:"毒菌蟾蜍"->默认
			RAGE = "这样的身躯竟然能如此灵活？！",		-- 物品名:"毒菌蟾蜍"->愤怒
		},
		MUSHROOMSPROUT =
		{
			GENERIC = "有趣的小帽子。",		-- 物品名:"孢子帽"->默认
			BURNT = "这不太好吧。",		-- 物品名:"孢子帽"->烧焦的
		},
		MUSHTREE_TALL =
		{
		...
		MUSHTREE_TALL_WEBBED = "洞穴蜘蛛们休息的地方。还是不要打扰它们了。",		-- 物品名:"蛛网蓝蘑菇树"
		SPORE_TALL =
		{
		...
		SLURTLE = "有着岩龙蜥一样坚硬的外壳。",		-- 物品名:"蛞蝓龟"
		SLURTLE_SHELLPIECES = "外壳的碎片",		-- 物品名:"壳碎片"
		SLURTLEHAT = "拟真的装备。",		-- 物品名:"背壳头盔"
		SLURTLEHOLE = "黏糊的洞穴。",		-- 物品名:"蛞蝓龟窝"
		SLURTLESLIME = "可以用作燃料。",		-- 物品名:"蛞蝓龟黏液"
		SNURTLE = "我们需要它的外壳。不要打碎了。",		-- 物品名:"蜗牛龟"
		SPIDER_HIDER = "会缩壳的。。蜘蛛？",		-- 物品名:"洞穴蜘蛛"
		SPIDER_SPITTER = "注意躲避。",		-- 物品名:"喷射蜘蛛"
		SPIDERHOLE = "它外面盖满了蛛网。",		-- 物品名:"蛛网岩"
		SPIDERHOLE_ROCK = "它外面盖满了蛛网。",		-- 物品名:"蛛网岩"
		STALAGMITE = "地下的石头。",		-- 物品名:"石笋"
		STALAGMITE_TALL = "石头，石头，石头，石头...",		-- 物品名:"石笋"->高大

		TURF_CARPETFLOOR = "牛毛地板。",		-- 物品名:"地毯地板" 制造描述:"超级柔软。闻着就像皮弗娄牛。"
		TURF_CHECKERFLOOR = "华丽的地板。",		-- 物品名:"棋盘地板" 制造描述:"精心制作成棋盘状的大理石地砖。"
		...
		TURF_DRAGONFLY = "看上去能防止火焰蔓延？",		-- 物品名:"龙鳞地板" 制造描述:"消除火灾蔓延速度。"
		...
		AMULET = "死而复生。",		-- 物品名:"重生护符" 制造描述:"逃离死神的魔爪。"
		ANIMAL_TRACK = "食物留下的踪迹。我指的是...一只动物。",		-- 物品名:"动物足迹"
		ARMORGRASS = "稍显脆弱的护甲。",		-- 物品名:"草甲" 制造描述:"提供少许防护。"
		ARMORMARBLE = "虽然很沉，但是很安全。",		-- 物品名:"大理石甲" 制造描述:"它很重，但能够保护你。"
		ARMORWOOD = "最经济的护甲。",		-- 物品名:"木甲" 制造描述:"为你抵御部分伤害。"
		ARMOR_SANITY = "穿着我虽然安全了，但深渊的侵蚀难以抵挡。",		-- 物品名:"魂甲" 制造描述:"保护你的躯体，但无法保护你的心智。"
		ASH =
		{
			GENERIC = "火焰舔舐后的残余物。",		-- 物品名:"灰烬"->默认
		...
		BACKPACK = "不错的背包，就是有点小。",		-- 物品名:"背包" 制造描述:"携带更多物品。"
		BACONEGGS = "营养均衡的食物。",		-- 物品名:"培根煎蛋"
		BANDAGE = "有助于伤口愈合。",		-- 物品名:"蜂蜜药膏" 制造描述:"愈合小伤口。"
		BASALT = "太硬了，敲不碎！", --removed		-- 物品名:"玄武岩"（彩蛋物体）
		BEARDHAIR = "这是威尔逊的，还是猴子的？",		-- 物品名:"胡子"
		BEARGER = "熊一样大的獾。",		-- 物品名:"熊獾"
		BEARGERVEST = "温暖舒适，让人安心。",		-- 物品名:"熊皮背心" 制造描述:"熊皮背心。"
		ICEPACK = "毛皮使包内有保温效果。",		-- 物品名:"保鲜背包" 制造描述:"容量虽小，但能保持东西新鲜。"
		BEARGER_FUR = "一块熊的毛皮。",		-- 物品名:"熊皮" 制造描述:"毛皮再生。"
		BEDROLL_STRAW = "看起来很舒适，适合路上短暂休息。",		-- 物品名:"草席卷" 制造描述:"一觉睡到天亮。"
		...
		BEEQUEENHIVEGROWN = "好大的蜂巢！那里面一定有什么危险的东西。",		-- 物品名:"巨大蜂窝"
		BEEGUARD = "它正在守卫女王。",		-- 物品名:"嗡嗡蜜蜂"
		HIVEHAT = "来自虫类的神奇力量。",		-- 物品名:"蜂王冠"
		MINISIGN =
		{
			GENERIC = "不错的画。",		-- 物品名:"小木牌"->画上了东西
		...
		BEE =
		{
			...
			HELD = "小心蜂刺。",		-- 物品名:"蜜蜂"->拿在手里
		},
		BEEBOX =
		{
			READY = "等着收获吧。",		-- 物品名:"蜂箱"->有很多蜂蜜 制造描述:"贮存你自己的蜜蜂。"
			FULLHONEY = "它已经装满了蜂蜜。",		-- 物品名:"蜂箱"->蜂蜜满了 制造描述:"贮存你自己的蜜蜂。"
			GENERIC = "蜜蜂！",		-- 物品名:"蜂箱"->默认 制造描述:"贮存你自己的蜜蜂。"
			NOHONEY = "蜜蜂需要一些时间的劳动。",		-- 物品名:"蜂箱"->没有蜂蜜 制造描述:"贮存你自己的蜜蜂。"
			SOMEHONEY = "还需要一些耐心等待。",		-- 物品名:"蜂箱"->有一些蜂蜜 制造描述:"贮存你自己的蜜蜂。"
			BURNT = "真遗憾。",		-- 物品名:"蜂箱"->烧焦的 制造描述:"贮存你自己的蜜蜂。"
		},
		MUSHROOM_FARM =
		{
			STUFFED = "不错的丰收。",		-- 物品名:"蘑菇农场"->长满了 制造描述:"种蘑菇。"
			LOTS = "木头上有很多蘑菇。",		-- 物品名:"蘑菇农场"->很多 制造描述:"种蘑菇。"
			SOME = "它还能继续生长。",		-- 物品名:"蘑菇农场"->有一些 制造描述:"种蘑菇。"
			EMPTY = "它可以使用一个孢子。或是一个蘑菇移植植物。",		-- 物品名:"蘑菇农场"->没有 制造描述:"种蘑菇。"
			ROTTEN = "木头的活力不够了。我们应该用另一个来替换它。",		-- 物品名:"蘑菇农场"->枯萎--需要活木 制造描述:"种蘑菇。"
			BURNT = "真遗憾。",		-- 物品名:"蘑菇农场"->烧焦的 制造描述:"种蘑菇。"
			SNOWCOVERED = "对蘑菇来说有些太冷了。",		-- 物品名:"蘑菇农场"->被雪覆盖 制造描述:"种蘑菇。"
		},
		BEEFALO =
		{
			FOLLOWER = "它在静静地跟着我。",		-- 物品名:"皮弗娄牛"->随从
		...
		BERRYBUSH_JUICY =
		{
			...
			BURNING = "着火了。",		-- 物品名:"多汁浆果丛"->正在燃烧
		},
		BIGFOOT = "那真是一只巨大无比的脚。",--removed		-- 物品名:"大脚怪"->大脚怪（单机）
		BIRDCAGE =
		{
			GENERIC = "放入一只好看的鸟儿是不错的选择。",		-- 物品名:"鸟笼"->空的 制造描述:"为你的鸟类朋友提供一个幸福的家。"
			OCCUPIED = "种子的来源。",		-- 物品名:"鸟笼"->有鸟 制造描述:"为你的鸟类朋友提供一个幸福的家。"
			...
			SKELETON = "死了啦，都是你害的啦。",		-- 物品名:"鸟笼"->骷髅
		},
		BIRDTRAP = "蛛网带来的收益。",		-- 物品名:"捕鸟陷阱" 制造描述:"捕捉会飞的动物。"
		CAVE_BANANA_BURNT = "不是我的错！",		-- 物品名:"洞穴香蕉树"->烧焦的 制造描述:"为你的鸟类朋友提供一个幸福的家。"
		BIRD_EGG = "能带来一整天的蛋白质！",		-- 物品名:"鸟蛋"
		BIRD_EGG_COOKED = "不错。",		-- 物品名:"煎蛋"
		BISHOP = "是什么在驱动着它？",		-- 物品名:"发条主教"
		BLOWDART_FIRE = "简易的火元素运用方式。",		-- 物品名:"火焰吹箭" 制造描述:"向你的敌人喷火。"
		BLOWDART_SLEEP = "不要倒吸进去。",		-- 物品名:"催眠吹箭" 制造描述:"催眠你的敌人。"
		BLOWDART_PIPE = "简易的远程攻击方式。",		-- 物品名:"吹箭" 制造描述:"向你的敌人喷射利齿。"
		BLOWDART_YELLOW = "附上了雷元素的远程攻击。",		-- 物品名:"雷电吹箭" 制造描述:"朝你的敌人放闪电。"
		BLUEAMULET = "富含冰元素，可惜不太持久。",		-- 物品名:"寒冰护符" 制造描述:"多么冰冷酷炫的护符。"
		BLUEGEM = "它散发着冰元素的光芒。",		-- 物品名:"蓝宝石"
		BLUEPRINT =
		{
			COMMON = "知识的传播方式。",		-- 物品名:"蓝图"
			RARE = "稀有的知识。",		-- 物品名:"蓝图"->罕见的
		},
		SKETCH = "一张雕像的图片。要找个地方才能做出来。",		-- 物品名:"{item}草图"
		COOKINGRECIPECARD = 
		{
			GENERIC = "虽然食谱可以用，但是我们应该有更好的方式。",	-- 物品名:"{item}食谱"
		},
		BLUE_CAP = "它很古怪，还黏黏的。",		-- 物品名:"采摘的蓝蘑菇"
		BLUE_CAP_COOKED = "干透了。",		-- 物品名:"烤蓝蘑菇"
		BLUE_MUSHROOM =
		{
			GENERIC = "是蘑菇。",		-- 物品名:"蓝蘑菇"->默认
			INGROUND = "它在睡觉。",		-- 物品名:"蓝蘑菇"->在地里面
			PICKED = "等待时间，或者雨水。",		-- 物品名:"蓝蘑菇"->被采完了
		},
		BOARDS = "木质的建材。",		-- 物品名:"木板" 制造描述:"更平直的木头。"
		BONESHARD = "一小片骨头。",		-- 物品名:"骨头碎片"
		BONESTEW = "极端的饱腹感。",		-- 物品名:"炖肉汤"
		BUGNET = "可以抓一些小虫子。",		-- 物品名:"捕虫网" 制造描述:"抓虫子用的。"
		BUSHHAT = "不错的伪装措施。",		-- 物品名:"灌木丛帽" 制造描述:"很好的伪装！"
		BUTTER = "这种食材不是加工自乳制品吗？",		-- 物品名:"黄油"
		BUTTERFLY =
		{
			GENERIC = "蝴蝶，扑扑翅膀飞走了。",		-- 物品名:"蝴蝶"->默认
			HELD = "抓到了。",		-- 物品名:"蝴蝶"->拿在手里
		},
		BUTTERFLYMUFFIN = "完美发挥了翅膀的治愈效果。",		-- 物品名:"蝴蝶松饼"
		BUTTERFLYWINGS = "可以用作书签。",		-- 物品名:"蝴蝶翅膀"
		BUZZARD = "多么奇怪的一只秃鹫！",		-- 物品名:"秃鹫"
		...
		CACTUS_MEAT_COOKED = "来自沙漠的烤制食品。",		-- 物品名:"烤仙人掌肉"
		CACTUS_MEAT = "要想把它变成一顿美味，还需要把上面的刺弄掉。",		-- 物品名:"仙人掌肉"
		CACTUS_FLOWER = "多刺植物开出的美丽花朵。它会结出赤念果吗？",		-- 物品名:"仙人掌花"
		...
		WATERMELON_SEEDS = "这是一颗西瓜种子。",		-- 物品名:"方形种子"
		CAVE_FERN = "它是一种蕨类植物。",		-- 物品名:"蕨类植物"
		CHARCOAL = "闻起来像烧焦的木头。",		-- 物品名:"木炭"
		...
		CHESSPIECE_MUSE = "不完整的雕塑。",		-- 物品名:"女王雕塑"
		CHESSPIECE_FORMAL = "看起来像一位统治者。",		-- 物品名:"国王雕塑"
		CHESSPIECE_HORNUCOPIA = "仅仅看着它就让我的肚子咕噜叫了。",		-- 物品名:"丰饶角雕塑"
		CHESSPIECE_PIPE = "奇怪的烟斗。",		-- 物品名:"泡泡烟斗雕塑"
		CHESSPIECE_DEERCLOPS = "它的目光在跟着你。",		-- 物品名:"独眼巨鹿雕塑"
		...
		CHESSPIECE_MINOTAUR = "两脚犀牛！",		-- 物品名:"远古守护者雕塑"
		CHESSPIECE_BUTTERFLY = "看着挺美的。",		-- 物品名:"月蛾雕塑"
		CHESSPIECE_ANCHOR = "果然和看上去一样沉。",		-- 物品名:"锚雕塑"
		CHESSPIECE_MOON = "这里的月亮似乎是一个谎言。",		-- 物品名:"“月亮” 雕塑"
		CHESSPIECE_CARRAT = "有人胜出了！",		-- 物品名:"胡萝卜鼠雕塑"
		CHESSPIECE_MALBATROSS = "它不追着杀你的时候还是挺可爱的。",		-- 物品名:"邪天翁雕塑"
		CHESSPIECE_CRABKING = "一个巨大的壳和一个小水虫。",		-- 物品名:"帝王蟹雕塑"
		CHESSPIECE_TOADSTOOL = "比起本体还是太小了，对吧？",		-- 物品名:"毒菌蟾蜍雕塑"
		CHESSPIECE_STALKER = "一动不动的骨架。",		-- 物品名:"远古织影者雕塑"
		CHESSPIECE_KLAUS = "也算是，年兽雕像？",		-- 物品名:"克劳斯雕塑"
		CHESSPIECE_BEEQUEEN = "蜜蜂的女王。",		-- 物品名:"蜂王雕塑"
		CHESSPIECE_ANTLION = "看起来不会再引起地震了。",		-- 物品名:"蚁狮雕塑"
		...
		CHESSPIECE_WARG_MUTATED = "月亮的气息挥之不去。",	-- 物品名:"附身座狼雕塑"
		...
		COOKEDMEAT = "优秀的食材！",		-- 物品名:"烤大肉"
		COOKEDMONSTERMEAT = "只比生吃的时候好一点点。",		-- 物品名:"烤怪物肉"
		COOKEDSMALLMEAT = "烤制保证了它的安全性。",		-- 物品名:"烤小肉"
		COOKPOT =
		{
			...
			BURNT = "谁用火把把锅点燃了？",		-- 物品名:"烹饪锅"->烧焦的 制造描述:"制作更好的食物。"
		},
		CORN = "玉蜀黍。",		-- 物品名:"玉米"
		CORN_COOKED = "熟玉蜀黍。",		-- 物品名:"爆米花"
		CORN_SEEDS = "这是一颗玉米种子。",		-- 物品名:"簇状种子"
		CANARY =
		{
			GENERIC = "带着雷电的鸟儿。",		-- 物品名:"金丝雀"->默认
			HELD = "我并没有在压扁你，不是吗？",		-- 物品名:"金丝雀"->拿在手里
		},
		CANARY_POISONED = "它看起来不太健康。",		-- 物品名:"金丝雀（中毒）"

		CRITTERLAB = "那里面有什么东西吗？",		-- 物品名:"岩石巢穴"
		CRITTER_GLOMLING = "可爱的小六眼飞鱼。",		-- 物品名:"小格罗姆"
		CRITTER_DRAGONLING = "看起来没那么火爆了。",		-- 物品名:"小龙蝇"
		...
		CUTGRASS = "草，很基础的材料。",		-- 物品名:"采下的草"
		CUTREEDS = "芦苇，可以用来造粗纸。",		-- 物品名:"采下的芦苇"
		CUTSTONE = "规整的石材。",		-- 物品名:"石砖" 制造描述:"切成正方形的石头。"
		DEADLYFEAST = "功效最强的大餐。", --unimplemented		-- 物品名:"致命的盛宴"->（单机）
		DEER =
		{
			GENERIC = "没有眼睛，它是怎么活下来的？",		-- 物品名:"无眼鹿"->默认
			ANTLER = "那些角看起来可以吸引一些什么。",		-- 物品名:"无眼鹿"->有角
		},
		DEER_ANTLER = "终于拿到了。",		-- 物品名:"鹿角"
		DEER_GEMMED = "巨兽的随从。",		-- 物品名:"无眼鹿"->克劳斯身边的宝石鹿
		DEERCLOPS = "小心它的冰冻。",		-- 物品名:"独眼巨鹿"
		DEERCLOPS_EYEBALL = "它只有一只眼。",		-- 物品名:"独眼巨鹿眼球"
		EYEBRELLAHAT =	"终于不用担心下雨耽误时间了！",		-- 物品名:"眼球伞" 制造描述:"面向天空的眼球让你保持干燥。"
		DEPLETED_GRASS =
		{
			GENERIC = "可能是一丛草。",		-- 物品名:"草"->枯萎
		},
		GOGGLESHAT = "这对护目镜可真时髦。",		-- 物品名:"时髦的护目镜" 制造描述:"你可以瞪大眼睛看装饰性护目镜。"
		DESERTHAT = "哈！不用担心沙尘暴了。",		-- 物品名:"沙漠护目镜" 制造描述:"从你的眼睛里把沙子揉出来。"
		ANTLIONHAT = "很方便的测绘装置。装饰也一样。",	-- 物品名:"刮地皮头盔" 制造描述:"通过去除旧地皮来摇出点新花样。"
		DEVTOOL = "闻起来像培根！",		-- 物品名:"开发工具"（未应用）
		DEVTOOL_NODEV = "我还不够壮，挥不动它。",		-- 物品名:"开发工具"（未应用）
		DIRTPILE = "跟着它！",		-- 物品名:"可疑的土堆"（翻大象）
		DIVININGROD =
		{
		...
		DRAGONFLY = "那是龙？还是虫？",		-- 物品名:"龙蝇"
		ARMORDRAGONFLY = "可以用来抵御一些火焰。",		-- 物品名:"鳞甲" 制造描述:"脾气火爆的盔甲。"
		DRAGON_SCALES = "还在冒出热气。",		-- 物品名:"鳞片"
		DRAGONFLYCHEST = "防火的箱子，看起来能放更多东西。",		-- 物品名:"龙鳞宝箱" 制造描述:"一种结实且防火的容器。"
		DRAGONFLYFURNACE =
		{
			HAMMERED = "看起来不太对。",		-- 物品名:"龙鳞火炉"->被锤了 制造描述:"给自己建造一个苍蝇暖炉。"
		...
		DRAGONFRUIT_SEEDS = "这是一颗火龙果种子。",		-- 物品名:"球茎状种子"
		...
		DECIDUOUSTREE =
		{
			...
			GENERIC = "应该趁他还有种子的时候砍下来。",		-- 物品名:"桦栗树"->默认
		},
		ACORN = "也可以用来饱腹。",		-- 物品名:"桦栗果"
		ACORN_SAPLING = "它很快将长成一棵树！",		-- 物品名:"桦栗树树苗"
		ACORN_COOKED = "完美的烤制。",		-- 物品名:"烤桦栗果"
		...
		EVERGREEN_SPARSE =
		{
			...
			GENERIC = "可惜，没有种子会留下。",		-- 物品名:"粗壮常青树"->默认
		},
		TWIGGYTREE =
		{
			...
			GENERIC = "可以多种一些，也是不错的树枝来源。",		-- 物品名:"多枝树"->默认
		...
		COOKBOOK = "应该让香菱来看看。",		-- 物品名:"烹饪指南" 制造描述:"查看你收集的食谱。"
		...
		FIREPIT =
		{
			...
			OUT = "可以再添一些燃料。",		-- 物品名:"火坑"->灭了 制造描述:"一种更安全、更高效的营火。"
		},
		COLDFIREPIT =
		{
			...
			OUT = "可以再添一些燃料。",		-- 物品名:"吸热火坑"->灭了 制造描述:"燃烧效率更高，但仍然越烤越冷。"
		},
		FIRESTAFF = "简单的火元素的利用方法。",		-- 物品名:"火魔杖" 制造描述:"利用火焰的力量！"
		FIRESUPPRESSOR =
		{
		...
		FISH = "制成烤鱼是更好的选择。",		-- 物品名:"鱼"
		FISHINGROD = "钩子、鱼线和棍子。",		-- 物品名:"钓竿" 制造描述:"去钓鱼。为了鱼。"
		FISHSTICKS = "还是做成烤鱼更好一些吧。",		-- 物品名:"炸鱼排"
		FISHTACOS = "松脆而美味！",		-- 物品名:"鱼肉玉米卷"
		FISH_COOKED = "烤得恰到好处。",		-- 物品名:"烤鱼"
		FLINT = "非常尖的石头。",		-- 物品名:"燧石"
		FLOWER =
		{
			GENERIC = "漂亮的小花。",		-- 物品名:"花"->默认
			ROSE = "很漂亮，但是带刺。",		-- 物品名:"花"->玫瑰
		},
		FLOWER_WITHERED = "我觉得它大概晒够太阳。",		-- 物品名:"枯萎的花"
		FLOWERHAT = "闻起来就很美。",		-- 物品名:"花环" 制造描述:"放松神经的东西。"
		FLOWER_EVIL = "有些被侵蚀的痕迹。",		-- 物品名:"邪恶花"
		FOLIAGE = "一些多叶植物。",		-- 物品名:"蕨叶"
		FOOTBALLHAT = "简易的防具。",		-- 物品名:"橄榄球头盔" 制造描述:"保护你的脑壳。"
		FOSSIL_PIECE = "可以用来拼一些什么。",		-- 物品名:"化石碎片"
		FOSSIL_STALKER =
		{
			GENERIC = "还有些碎片没找到。",		-- 物品名:"奇异的骨架"->默认
			FUNNY = "我的直觉告诉我这有点不对。",		-- 物品名:"奇异的骨架"->错误
			COMPLETE = "它活着！哦等等，它还没有。",		-- 物品名:"奇异的骨架"->准备好了
		},
		STALKER = "骨架和暗影融合在一起！",		-- 物品名:"复活的骨架"
		STALKER_ATRIUM = "必须要小心了！",		-- 物品名:"远古织影者"
		STALKER_MINION = "会咬到脚踝！",		-- 物品名:"编织暗影"
		THURIBLE = "危险的香炉。",		-- 物品名:"暗影香炉"
		ATRIUM_OVERGROWTH = "应该请钟离客卿来辨认一下这些文字。",		-- 物品名:"远古方尖碑"
		FROG =
		{
			DEAD = "他挂了。",		-- 物品名:"青蛙"->死了
		...
		FURTUFT = "黑白的毛皮。",		-- 物品名:"毛丛"
		GEARS = "质量不错的机械零件。",		-- 物品名:"齿轮"
		GHOST = "应该请往生堂来处理。",		-- 物品名:"幽灵"
		GOLDENAXE = "更耐用的一把斧头。",		-- 物品名:"黄金斧头" 制造描述:"砍树也要有格调！"
		GOLDENPICKAXE = "金子不是软的吗？",		-- 物品名:"黄金鹤嘴锄" 制造描述:"像大Boss一样砸碎岩石。"
		GOLDENPITCHFORK = "测绘地皮！",		-- 物品名:"黄金干草叉" 制造描述:"重新布置整个世界。"
		GOLDENSHOVEL = "更耐用的铲子。",		-- 物品名:"黄金铲子" 制造描述:"挖掘作用相同，但使用寿命更长。"
		GOLDNUGGET = "闪闪发光。",		-- 物品名:"金块"
		GRASS =
		{
			BARREN = "它需要肥料。",		-- 物品名:"草"->采摘过多枯萎了
			WITHERED = "天气这么热，它不会长回来。",		-- 物品名:"草"->天热枯萎了
			BURNING = "烧得好快！",		-- 物品名:"草"->正在燃烧
			GENERIC = "自然的资源。",		-- 物品名:"草"->默认
			PICKED = "被采走的残余物。",		-- 物品名:"草"->被采完了
			DISEASED = "它看上去很不舒服。", --unimplemented		-- 物品名:"草"->生病了（已移除）
			DISEASING = "呃...有些地方不对劲。", --unimplemented		-- 物品名:"草"->正在生病（已移除）
		},
		GRASSGEKKO =
		{
			GENERIC = "这是一只草蜥蜴？",		-- 物品名:"草壁虎"->默认
		...
		GUNPOWDER = "闻起来像火史莱姆。",		-- 物品名:"火药" 制造描述:"一把火药。"
		HAMBAT = "真是新奇的武器。",		-- 物品名:"火腿棒" 制造描述:"舍不得火腿套不着狼。"
		HAMMER = "敲碎掉一些东西才能腾出空间。",		-- 物品名:"锤子" 制造描述:"敲碎各种东西。"
		...
		HOUNDCORPSE =
		{
			...
			REVIVING = "来自天空的力量复活了它们。",		-- 物品名:"猎犬"->复活为恐怖猎犬
		},
		HOUNDBONE = "吓人。",		-- 物品名:"犬骨"
		HOUNDMOUND = "应当斩草除根。",		-- 物品名:"猎犬丘"
		ICEBOX = "可以让食材更耐久一些。",		-- 物品名:"冰箱" 制造描述:"延缓食物变质。"
		ICEHAT = "保持冷静。",		-- 物品名:"冰帽" 制造描述:"用科学技术合成的冰帽。"
		ICEHOUND = "它体内流淌着冰元素。",		-- 物品名:"蓝色猎犬"
		INSANITYROCK =
		{
			ACTIVE = "我需要降低一下理智。",		-- 物品名:"方尖碑"->理智高的时候激活了
		...
		KRAMPUS_SACK = "空间不小，但还是不太够。",		-- 物品名:"坎普斯背包"
		LEIF = "他真巨大！",		-- 物品名:"树精守卫"->常青树
		LEIF_SPARSE = "他真巨大！",		-- 物品名:"树精守卫"->粗壮常青树
		LIGHTER  = "她的幸运打火机。",		-- 物品名:"薇洛的打火机" 制造描述:"火焰在雨中彻夜燃烧。"
		LIGHTNING_ROD =
		{
			CHARGED = "它能产出电池吗？",		-- 物品名:"避雷针"->充能 制造描述:"防雷劈。"
			GENERIC = "事雷元素。",		-- 物品名:"避雷针"->默认 制造描述:"防雷劈。"
		},
		LIGHTNINGGOAT =
		{
		...
		LOG =
		{
			...
			GENERIC = "基础的木材。",		-- 物品名:"木头"->默认
		},
		LUCY = "这斧子比我之前用过的那把还漂亮。",		-- 物品名:"露西斧"
		LUREPLANT = "它如此迷人。",		-- 物品名:"食人花"
		LUREPLANTBULB = "现在我可以开办我自己的叶肉农场了。",		-- 物品名:"食人花种子"
		...
		MARBLE = "安如磐石。",		-- 物品名:"大理石"
		MARBLEBEAN = "让我想起了蒙德的一些童话故事。",		-- 物品名:"大理石豌豆" 制造描述:"种植一片大理石森林。"
		...
		MAXWELL = "心怀鬼胎的家伙。",--single player		-- 物品名:"麦斯威尔"->（单机）
		...
		MEATRACK =
		{
			...
			DONE_NOTMEAT = "晾干了。",		-- 物品名:"晾肉架"->完成了非肉 制造描述:"晾肉的架子。"
			DRYING_NOTMEAT = "我们需要一些等待。",		-- 物品名:"晾肉架"->正在风干非肉 制造描述:"晾肉的架子。"
			DRYINGINRAIN_NOTMEAT = "水龙水龙别哭啦。",		-- 物品名:"晾肉架"->雨天风干非肉 制造描述:"晾肉的架子。"
		},
		MEAT_DRIED = "这肉够干的了。",		-- 物品名:"风干肉"
		MERM = "鱼腥味十足！",		-- 物品名:"鱼人"
		MERMHEAD =
		{
			GENERIC = "闻起来并不是很理想。",		-- 物品名:"鱼人头"->默认
			BURNT = "烧过的鱼人肉闻起来更糟糕了。",		-- 物品名:"鱼人头"->烧焦的
		},
		MERMHOUSE =
		{
			GENERIC = "谁会住在这种地方？",		-- 物品名:"漏雨的小屋"->默认
			BURNT = "它是如何做到同时漏雨与烧焦的？",		-- 物品名:"漏雨的小屋"->烧焦的
		},
		MINERHAT = "免持照明装置。",		-- 物品名:"矿工帽" 制造描述:"用你脑袋上的灯照亮夜晚。"
		MONKEY = "最烦人的东西。",		-- 物品名:"穴居猴"
		MONKEYBARREL = "那东西刚刚是不是动了？",		-- 物品名:"穴居猴桶"
		MONSTERLASAGNA = "这东西。。能吃吗？",		-- 物品名:"怪物千层饼"
		...
		MOOSE = "巨大的。。鹅？",		-- 物品名:"麋鹿鹅"
		MOOSE_NESTING_GROUND = "它把它的孩子放在那里。",		-- 物品名:"麋鹿鹅巢"
		MOOSEEGG = "小鹅们有些躁动了。",		-- 物品名:"麋鹿鹅蛋"
		MOSSLING = "有些危险。",		-- 物品名:"麋鹿鹅幼崽"
		...
		STAFF_TORNADO = "旋转的风的力量。",		-- 物品名:"天气风向标" 制造描述:"把你的敌人吹走。"
		MOSQUITO =
		{
		...
		PANDORASCHEST = "东西收拾好，就继续上路吧。",		-- 物品名:"华丽箱子"
		PANFLUTE = "催眠的小曲。",		-- 物品名:"排箫" 制造描述:"抚慰凶猛野兽的音乐。"
		PAPYRUS = "一些纸，用于书写。",		-- 物品名:"莎草纸" 制造描述:"用于书写。"
		WAXPAPER = "一些蜡纸，可以打包些什么。",		-- 物品名:"蜡纸" 制造描述:"用于打包东西。"
		PENGUIN = "肯定到繁殖季节了。",		-- 物品名:"企鸥"
		PERD = "离那些浆果远点！",		-- 物品名:"火鸡"
		PEROGIES = "其他国家的饺子吗？",		-- 物品名:"波兰水饺"
		PETALS = "摘下依然美丽。",		-- 物品名:"花瓣"
		PETALS_EVIL = "可以不拿些东西吗？",		-- 物品名:"恶魔花瓣"
		PHLEGM = "有些恶心。",		-- 物品名:"脓鼻涕"
		PICKAXE = "很形象，不是吗？",		-- 物品名:"鹤嘴锄" 制造描述:"凿碎岩石。"
		PIGGYBACK = "略感疲惫。",		-- 物品名:"小猪包" 制造描述:"能装许多东西，但会减慢你的速度。"
		PIGHEAD =
		{
		...
		PIGMAN =
		{
			...
			WEREPIG = "不是很友善的猪！！",		-- 物品名:"猪人"->疯猪
		},
		PIGSKIN = "可以用来做很多东西。",		-- 物品名:"猪皮"
		...
		PUMPKIN_SEEDS = "这是一颗南瓜种子。",		-- 物品名:"尖种子"
		PURPLEAMULET = "它在向我低语。",		-- 物品名:"梦魇护符" 制造描述:"引起精神错乱。"
		PURPLEGEM = "它包含深渊与沉沦。",		-- 物品名:"紫宝石" 制造描述:"结合你们的颜色！"
		RABBIT =
		{
			GENERIC = "他在找胡萝卜。",		-- 物品名:"兔子"->默认
			HELD = "你喜欢胡萝卜吗？",		-- 物品名:"兔子"->拿在手里
		},
		RABBITHOLE =
		{
		...
		RESEARCHLAB =
		{
			GENERIC = "最基础的制造工具。",		-- 物品名:"科学机器"->默认 制造描述:"解锁新的合成配方！"
			BURNT = "现在没法继续研究了。",		-- 物品名:"科学机器"->烧焦的 制造描述:"解锁新的合成配方！"
		},
		RESEARCHLAB2 =
		{
			GENERIC = "比起上一个更进了一步。",		-- 物品名:"炼金引擎"->默认 制造描述:"解锁更多合成配方！"
		...
		CAVEIN_BOULDER =
		{
			...
			RAISED = "太远了，够不着。",		-- 物品名:"岩石"->洞穴内蚁狮地震时落在中间被其他石头托起
		},
		...
		ROTTENEGG = "味道有些刺鼻。",		-- 物品名:"腐烂鸟蛋"
		ROYAL_JELLY = "蜂蜜的精华。",		-- 物品名:"蜂王浆"
		JELLYBEAN = "治愈性的糖丸。",		-- 物品名:"彩虹糖豆"
		SADDLE_BASIC = "有了它就可以骑牛了。",		-- 物品名:"鞍具" 制造描述:"你坐在动物身上。仅仅是理论上。"
		SADDLE_RACE = "这鞍具真的在飞！",		-- 物品名:"闪亮鞍具" 制造描述:"抵消掉完成目标所花费的时间。或许。"
		SADDLE_WAR = "冲刺！",		-- 物品名:"战争鞍具" 制造描述:"战场首领的王位。"
		...
		SAPLING =
		{
			...
			GENERIC = "可爱的小树苗。",		-- 物品名:"树苗"->默认
			PICKED = "又是一次努力的生长。",		-- 物品名:"树苗"->被采完了
   		...
   		SCULPTINGTABLE=
   		{
			...
			SCULPTURE = "不错的作品。",		-- 物品名:"陶轮"->雕像做好了 制造描述:"大理石在你手里将像黏土一样！"
			BURNT = "完全烧焦了。",		-- 物品名:"陶轮"->烧焦的 制造描述:"大理石在你手里将像黏土一样！"
   		},
		SCULPTURE_KNIGHTHEAD = "其余部分在哪里？",		-- 物品名:"可疑的大理石"->骑士的头
		SCULPTURE_KNIGHTBODY =
		{
			COVERED = "是一个古怪的大理石雕像。",		-- 物品名:"大理石雕像"->骑士雕像被裹住，可以开采大理石
			UNCOVERED = "它不完整。",		-- 物品名:"大理石雕像"->开采后骑士雕像露出来了
		...
		SCULPTURE_BISHOPBODY =
		{
			...
			UNCOVERED = "缺了一块部件。",		-- 物品名:"大理石雕像"->开采后主教雕像露出来了
		...
		SCULPTURE_ROOKBODY =
		{
			...
			UNCOVERED = "它需要修复。",		-- 物品名:"大理石雕像"->开采后战车雕像露出来了
		...
		SPAT = "它的粘液有点难搞。。！",		-- 物品名:"钢羊"
		SPEAR = "方便的武器。",		-- 物品名:"长矛" 制造描述:"使用尖的那一端。"
		SPEAR_WATHGRITHR = "更加锋利的武器。",		-- 物品名:"战斗长矛" 制造描述:"黄金使它更锋利。"
		WATHGRITHRHAT = "更耐用的护具。",		-- 物品名:"战斗头盔" 制造描述:"独角兽是你的保护神。"
		SPIDER =
		{
			DEAD = "恶心！",		-- 物品名:"蜘蛛"->死了
		...
		SPOILED_FOOD = "烂掉了，但是还可以用作肥料。",		-- 物品名:"腐烂物"
		STAGEHAND =
		{
			AWAKE = "总之不要伸出你的手，好吗？",		-- 物品名:"舞台之手"->醒了
			HIDING = "希望它不会站起来跑路。",		-- 物品名:"舞台之手"->藏起来了
		},
		STATUE_MARBLE =
		{
			GENERIC = "高级的大理石雕像。",		-- 物品名:"大理石雕像"->卒子
			TYPE1 = "它缺少了点什么。",		-- 物品名:"大理石雕像"->持剑无头查理
			TYPE2 = "应该很难修复了。",		-- 物品名:"大理石雕像"->持杖无头查理
		...
		TENT =
		{
			GENERIC = "耽误太多时间，事情可就做不完了。",		-- 物品名:"帐篷"->默认 制造描述:"回复理智值，但要花费时间并导致饥饿。"
			BURNT = "不剩什么睡觉的东西了。",		-- 物品名:"帐篷"->烧焦的 制造描述:"回复理智值，但要花费时间并导致饥饿。"
		},
		SIESTAHUT =
		{
			GENERIC = "午休并不是一个很好的习惯。",		-- 物品名:"遮阳篷"->默认 制造描述:"躲避烈日，回复理智值。"
			BURNT = "它现在遮不了多少阳了。",		-- 物品名:"遮阳篷"->烧焦的 制造描述:"躲避烈日，回复理智值。"
		},
		TENTACLE = "那个看起来很危险。",		-- 物品名:"触手"
		TENTACLESPIKE = "它又尖又黏。",		-- 物品名:"触手尖刺"
		TENTACLESPOTS = "至少可以拿来作雨衣。",		-- 物品名:"触手皮"
		TENTACLE_PILLAR = "黏滑的触手。",		-- 物品名:"大触手"
		TENTACLE_PILLAR_HOLE = "似乎很深，但值得一探。",		-- 物品名:"硕大的泥坑"
		TENTACLE_PILLAR_ARM = "滑溜溜的小触手。",		-- 物品名:"小触手"
		TENTACLE_GARDEN = "又一种黏滑的触手。",		-- 物品名:"大触手"
		TOPHAT = "不错的装饰。",		-- 物品名:"高礼帽" 制造描述:"最经典的帽子款式。"
		TORCH = "简易的照明。",		-- 物品名:"火炬" 制造描述:"可携带的光源。"
		TRANSISTOR = "科技的基础。",		-- 物品名:"电子元件" 制造描述:"科学至上！滋滋滋！"
		...
		TREASURECHEST =
		{
			GENERIC = "可以装一些东西。",		-- 物品名:"箱子"->默认 制造描述:"一种结实的容器。"
		...
		TUMBLEWEED = "开盲盒时间。",		-- 物品名:"风滚草"
		TURKEYDINNER = "啧~",		-- 物品名:"火鸡大餐"
		TWIGS = "一堆小树枝。",		-- 物品名:"树枝"
		UMBRELLA = "猪皮的材质决定了它不能完全防雨。",		-- 物品名:"雨伞" 制造描述:"遮阳挡雨！"
		GRASS_UMBRELLA = "多少有些保护作用。",		-- 物品名:"花伞" 制造描述:"漂亮轻便的保护伞。"
		...
		WALL_DREADSTONE = "奢侈，但是牢固。",	-- 物品名:"绝望石墙"
		...
		WALRUS = "当心它的吹箭。。别跑！",		-- 物品名:"海象"
		WALRUSHAT = "很潮流的帽子。",		-- 物品名:"贝雷帽"
		WALRUS_CAMP =
		{
			EMPTY = "要到冬天才会有人来盖房子。",		-- 物品名:"海象营地"->非冬季时没有房子
			GENERIC = "看起来里面温暖而舒适。",		-- 物品名:"海象营地"->默认
		},
		WALRUS_TUSK = "很好，我们有步行手杖用了。",		-- 物品名:"海象牙"
		WARDROBE =
		{
			GENERIC = "可以换衣服了。",		-- 物品名:"衣柜"->默认 制造描述:"随心变换面容。"
			BURNING = "烧得好快！",		-- 物品名:"衣柜"->正在燃烧 制造描述:"随心变换面容。"
			BURNT = "毫无风格可言。",		-- 物品名:"衣柜"->烧焦的 制造描述:"随心变换面容。"
		},
		WARG = "做好准备，不要让它叫来太多！",		-- 物品名:"座狼"
		WARGLET = "至少它不会呼朋引伴。",	--物品名:"小座狼"

		WASPHIVE = "我看那些蜜蜂都发疯了。",		-- 物品名:"杀人蜂蜂窝"
		WATERBALLOON = "水元素还真是方便。",		-- 物品名:"水球" 制造描述:"球体灭火。"
		WATERMELON = "避暑的好东西！",		-- 物品名:"西瓜"
		WATERMELON_COOKED = "多汁而温热。",		-- 物品名:"烤西瓜"
		WATERMELONHAT = "这种避暑方式有些极端了。",		-- 物品名:"西瓜帽" 制造描述:"提神醒脑，但感觉黏黏的。"
		WAXWELLJOURNAL =
		{
			GENERIC = "真可怕。",		-- 物品名:"暗影秘典"->默认 制造描述:"这将让你大吃一惊。"
			NEEDSFUEL = "only_used_by_waxwell",	-- 物品名:"暗影秘典"->噩梦燃料不足 制造描述:"这将让你大吃一惊。"（老麦专用）
		},
		WETGOOP = "皇帝的新餐。",		-- 物品名:"失败料理"
		WHIP = "它只会往野兽身上挥舞。",		-- 物品名:"皮鞭" 制造描述:"提出有建设性的反馈意见。"
		WINTERHAT = "提供一些保暖效果。",		-- 物品名:"冬帽" 制造描述:"保持脑袋温暖。"
		WINTEROMETER =
		{
		...
		WINTER_ORNAMENT = "一个好的玩意。",		-- 物品名:"圣诞小玩意"
		WINTER_ORNAMENTLIGHT = "一棵树没有灯光就不算完整。",		-- 物品名:"圣诞灯"
		...
		WINTERSFEASTOVEN =
		{
			...
			DISH_READY = "完成了。",		-- 物品名:"砖砌烤炉"->已做好 制造描述:"燃起了喜庆的火焰。"
		},
		...
		KLAUS = "奇看上去不是很友善。",		-- 物品名:"克劳斯"
		KLAUS_SACK = "打开战利品应该在战斗之后。",		-- 物品名:"赃物袋"
		KLAUSSACKKEY = "这次是正确的钥匙了。",		-- 物品名:"麋鹿茸"
		WORMHOLE =
		{
			GENERIC = "看起来是个快速旅行的方式。",		-- 物品名:"虫洞"->默认
			OPEN = "我应该进去吗？",		-- 物品名:"虫洞"->打开
		},
		...
		LIVINGTREE = "可能要小心一点它的注视？",		-- 物品名:"完全正常的树"
		ICESTAFF = "简易的冰元素使用方式。",		-- 物品名:"冰魔杖" 制造描述:"把敌人冰冻在原地。"
		REVIVER = "希望永远不要派上用场。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
		SHADOWHEART = "它还在跳动。。",		-- 物品名:"暗影心房"
		ATRIUM_RUBBLE =
		{
		...
		ATRIUM_GATE =
		{
			...
			COOLDOWN = "即使是暗影的力量也需要再次充能的时间。",		-- 物品名:"远古大门"->冷却中
		},
		ATRIUM_KEY = "这是从它里面发射出来的能量。",		-- 物品名:"远古钥匙"
		LIFEINJECTOR = "可能会有点痛，但为了治疗是必须的。",		-- 物品名:"强心针" 制造描述:"提高下你那日渐衰退的最大健康值吧。"
		SKELETON_PLAYER =
		{
		...
		HUMANMEAT = "突破了道德的底线。",		-- 物品名:"长猪"
		HUMANMEAT_COOKED = "煮的粉嫩，但在道德上还是灰色地带。",		-- 物品名:"煮熟的长猪"
		HUMANMEAT_DRIED = "这是不合理的。",		-- 物品名:"长猪肉干"
		ROCK_MOON = "那块石头来自天上。",		-- 物品名:"岩石"
		MOONROCKNUGGET = "那块石头来自天上。",		-- 物品名:"月岩"
		MOONROCKCRATER = "这个凹槽很适合一个宝石。",		-- 物品名:"带孔月岩" 制造描述:"用于划定地盘的岩石。"
		MOONROCKSEED = "来自天上的科技。",		-- 物品名:"天体宝球"
		...
		STEERINGWHEEL = "北斗船长或许会更得心应手。",		-- 物品名:"方向舵" 制造描述:"航海必备道具。"
		ANCHOR = "用来固定小船。",		-- 物品名:"锚" 制造描述:"船用刹车"
		...
		MOONBUTTERFLY =
		{
			GENERIC = "这是一只月光蝴蝶，但能比常见的蝴蝶长出更大的东西。",		-- 物品名:"月蛾"->默认
			HELD = "这下抓到你了。",		-- 物品名:"月蛾"->拿在手里
		},
		MOONBUTTERFLYWINGS = "飞蛾翅膀，有独特的美感。",		-- 物品名:"月蛾翅膀"
		MOONBUTTERFLY_SAPLING = "这就是来自天空的生命力吗。",		-- 物品名:"月树苗"
		ROCK_AVOCADO_FRUIT = "需要开采之后再吃。",		-- 物品名:"石果"
		...
		DEAD_SEA_BONES = "它不该来到岸上的。",		-- 物品名:"海骨"
		HOTSPRING =
		{
		...
		MOONGLASS_CHARGED = "它的能量很快就要耗尽了。",		-- 物品名:"注能月亮碎片"
		MOONGLASS_ROCK = "我都能看到自己的倒影。",		-- 物品名:"月光玻璃"
		BATHBOMB = "爆炸！",		-- 物品名:"沐浴球" 制造描述:"春天里来百花香？这点子把地都炸碎了"
		TRAP_STARFISH =
		{
			GENERIC = "看上去很普通，但很危险。",		-- 物品名:"海星"->默认
			CLOSED = "趁它还没恢复，挖出来吧。",		-- 物品名:"海星"->合上了
		},
		...
		MOONSPIDERDEN = "那蜘蛛巢看上去是活的。",		-- 物品名:"破碎蜘蛛洞"
		FRUITDRAGON =
		{
			GENERIC = "挺可爱的，不过还不熟。",		-- 物品名:"沙拉蝾螈"->默认
		...
		MOONGLASSAXE = "很锋利，但是过于脆弱了。",		-- 物品名:"月光玻璃斧" 制造描述:"脆弱而有效。"
		GLASSCUTTER = "很锋利，但是一样很脆弱。",		-- 物品名:"玻璃刀" 制造描述:"尖端武器。"
		...
		MEGAFLARE = "它可能会招来一些危险的东西。",	-- 物品名:"敌对信号弹" 制造描述:"为你的敌人点亮一束光。"
		...
		MOON_ALTAR_CROWN = "一系列努力的成果。我们要找个地方插下来。",		-- 物品名:"未激活天体贡品"
		...
		SEAFARING_PROTOTYPER =
		{
			...
			BURNT = "真遗憾。",		-- 物品名:"智囊团"->烧焦的 制造描述:"海上科学。"
		},
		BOAT_ITEM = "航行的基础。",		-- 物品名:"船套装" 制造描述:"让大海成为你的领地。"
		...
		BULLKELP_PLANT =
		{
			GENERIC = "很方便的作物。",		-- 物品名:"公牛海带"->默认
			PICKED = "它需要一些时间长出来。",		-- 物品名:"公牛海带"->被采完了
		},
		...
		GESTALT = "注意保持距离！",		-- 物品名:"虚影"
		GESTALT_GUARD = "不要靠近！",		-- 物品名:"大虚影"

		COOKIECUTTER = "小心！它们对甲板虎视眈眈。",		-- 物品名:"饼干切割机"
		COOKIECUTTERSHELL = "只剩空壳了。",		-- 物品名:"饼干切割机壳"
		...
		SALTROCK = "可以腌制一些食物。",		-- 物品名:"盐晶"
		SALTBOX = "进一步减缓食材变质。",		-- 物品名:"盐盒" 制造描述:"用盐来储存食物。"

		TACKLESTATION = "是时候解决海钓的问题了。",		-- 物品名:"钓具容器" 制造描述:"传统的用饵钓鱼。"
		TACKLESKETCH = "某种钓具的图片，可以用钓具容器学习。",		-- 物品名:"{item}广告"
		...
		OCEANFISHABLEFLOTSAM = "应该打开它。",		-- 物品名:"海洋残骸"
		...
		TRIDENT = "炸鱼时间！",		-- 物品名:"刺耳三叉戟" 制造描述:"在汹涌波涛中引领潮流吧！"
		...
		HERMITHOUSE = {
			GENERIC = "我们需要帮她修缮一下。",		-- 物品名:"隐士之家"->默认
		...
		CHUM = "可以吸引一些鱼。",		-- 物品名:"鱼食" 制造描述:"鱼儿的美食。"
		...
		RESKIN_TOOL = "可以用清洁扫把扫清洁扫把吗？",		-- 物品名:"清洁扫把" 制造描述:"把装潢的东西清扫的干干净净。"
		MOON_FISSURE_PLUGGED = "最有效的方式。",		-- 物品名:"堵住的裂隙"
		...
		SPICEPACK = "很方便，但有点多余。",		-- 物品名:"厨师袋" 制造描述:"使你的食物保持新鲜。"
		SPICE_GARLIC = "有着庇护的力量。",		-- 物品名:"蒜粉" 制造描述:"用口臭防守是最好的进攻。"
		SPICE_SUGAR = "很甜。",		-- 物品名:"蜂蜜水晶" 制造描述:"令人心平气和的甜美。"
		SPICE_CHILI = "虽然有些刺激，但是有利于进攻。",		-- 物品名:"辣椒面" 制造描述:"刺激十足的粉末。"
		...
		BONESOUP = "希望煮的不是萌新。但愿吧。",		-- 物品名:"骨头汤"
		MASHEDPOTATOES = "香气扑鼻。",		-- 物品名:"奶油土豆泥"
		POTATOSOUFFLE = "我都忘记了可口的饭菜是什么味道！",		-- 物品名:"蓬松土豆蛋奶酥"
		MOQUECA = "不错的料理，如果有虾就更好了。",		-- 物品名:"海鲜杂烩"
		GAZPACHO = "真好吃。",		-- 物品名:"芦笋冷汤"
		ASPARAGUSSOUP = "闻起来很好吃。",		-- 物品名:"芦笋汤"
		VEGSTINGER = "你能把芹菜当吸管用吗？",		-- 物品名:"蔬菜鸡尾酒"
		BANANAPOP = "清凉可口的小零食。",		-- 物品名:"香蕉冻"
		...
		POTATO_SEEDS = "一把沃尔夫冈的种子。",		-- 物品名:"毛茸茸的种子"

		TOMATO = "它是水果还是蔬菜？",		-- 物品名:"番茄"
		TOMATO_COOKED = "懂化学的话做饭就非常简单了。",		-- 物品名:"烤番茄"
		TOMATO_SEEDS = "一把番茄种子。",		-- 物品名:"带刺的种子"

		ASPARAGUS = "一种蔬菜。",		-- 物品名:"芦笋"
		ASPARAGUS_COOKED = "科学说这对我有好处。",		-- 物品名:"烤芦笋"
		ASPARAGUS_SEEDS = "就是些芦笋种子。",		-- 物品名:"筒状种子"

		PEPPER = "好一个火辣辣的辣椒。",		-- 物品名:"辣椒"
		PEPPER_COOKED = "本来就是辣的。",		-- 物品名:"烤辣椒"
		PEPPER_SEEDS = "一把辣椒种子。",		-- 物品名:"块状种子"
		...
		CRABKING =
		{
			GENERIC = "巨大的城堡。",		-- 物品名:"帝王蟹"->默认
			INERT = "那座城堡需要装修一下。",		-- 物品名:"帝王蟹"->未唤醒
		},
		CRABKING_CLAW = "当心你的船！",		-- 物品名:"巨钳"

		MESSAGEBOTTLE = "其中承载着思念。",		-- 物品名:"瓶中信"
		...
		MEATRACK_HERMIT =
		{
			...
			DONE_NOTMEAT = "我们管它叫“干燥”。",		-- 物品名:"晾肉架"->完成了非肉
			DRYING_NOTMEAT = "需要一些时间。",		-- 物品名:"晾肉架"->正在风干非肉
			DRYINGINRAIN_NOTMEAT = "水龙，水龙，别哭啦。",		-- 物品名:"晾肉架"->雨天风干非肉
		},
		BEEBOX_HERMIT =
		{
		...
		MASTUPGRADE_LIGHTNINGROD_ITEM = "能有效避免船只着火。",		-- 物品名:"避雷导线" 制造描述:"为你的桅杆带来过电般的刺激。"

		WATERPUMP = "可以非常有效的灭火。",		-- 物品名:"消防泵" 制造描述:"水水水，到处都是水！"

		BARNACLE = "一种另类的食材。",		-- 物品名:"藤壶"
		...
		MEATYSALAD = "区区一份沙拉，居然这么顶饱。",		-- 物品名:"牛肉绿叶菜"
		...
		ARCHIVE_CENTIPEDE = "有些像遗迹巨蛇。当心！",		-- 物品名:"远古哨兵蜈蚣"
		ARCHIVE_CENTIPEDE_HUSK = "破烂不堪。",		-- 物品名:"哨兵蜈蚣壳"
		...
		ARCHIVE_MOON_STATUE = "这些宏伟的月亮雕像让我想起了一些传说。",		-- 物品名:"远古月亮雕像"
		ARCHIVE_RUNE_STATUE =
		{
			LINE_1 = "如此多的知识，应该请钟离客卿来辨认一下。",		-- 物品名:"远古月亮符文石"->第一行
			LINE_2 = "这些标记看起来与其他废墟中的标记不同。",		-- 物品名:"远古月亮符文石"->第二行
			LINE_3 = "如此多的知识，应该请钟离客卿来辨认一下。",		-- 物品名:"远古月亮符文石"->第三行
			LINE_4 = "这些标记看起来与其他废墟中的标记不同。",		-- 物品名:"远古月亮符文石"->第四行
			LINE_5 = "如此多的知识，应该请钟离客卿来辨认一下。",		-- 物品名:"远古月亮符文石"->第五行
		},
		...
		ARCHIVE_RESONATOR_ITEM = "一个不错的探测装备。",		-- 物品名:"天体探测仪"->携带物状态 制造描述:"它会出土什么秘密呢？"
		...
		TURFCRAFTINGSTATION = "改变地质的实用工具。",		-- 物品名:"土地夯实器" 制造描述:"一点点的改变世界。"
		...
		COMPOSTINGBIN =
		{
			GENERIC = "有点难闻，但很有用。",		-- 物品名:"堆肥桶"->默认 制造描述:"能让土壤变得臭烘烘和肥沃。"
		...
		SOIL_AMENDER =
		{
			GENERIC = "它需要一些时间来发酵",		-- 物品名:"催长剂起子"->默认 制造描述:"海里来的瓶装养分。"
			STALE = "时间还不够。",		-- 物品名:"催长剂起子"->过期了 制造描述:"海里来的瓶装养分。"
			SPOILED = "经过足够的时间，它起作用了。",		-- 物品名:"催长剂起子"->腐烂了 制造描述:"海里来的瓶装养分。"
		},

		SOIL_AMENDER_FERMENTED = "这可是很强的肥料。",		-- 物品名:"超级催长剂"
		...
		TILLWEED = "以普遍理性而言，它确实没多少用处。",		-- 物品名:"犁地草"
		TILLWEEDSALVE = "我的救赎。",		-- 物品名:"犁地草膏" 制造描述:"慢慢去处病痛。"
		WEED_IVY = "当心！",		-- 物品名:"刺针旋花"
		IVY_SNARE = "真是没礼貌。",		-- 物品名:"缠绕根须"

		TROPHYSCALE_OVERSIZEDVEGGIES =
		{
			GENERIC = "一个准确的秤是一些契约的基础。",		-- 物品名:"农产品秤"->默认 制造描述:"称量你珍贵的水果和蔬菜。"
		...
		POTATO_OVERSIZED = "这沃尔夫冈真大。",		-- 物品名:"巨型土豆"
		...
		FARM_PLANT =
		{
			...
			FULL_OVERSIZED = "生产出了巨型农作物!",		-- 物品名:"作物植株"->巨型作物
		...
		FRUITFLYFRUIT = "现在它听我的了。",		-- 物品名:"友好果蝇果"
		...
		ALTERGUARDIAN_PHASE1 = {
			GENERIC = "一个值得注意的强敌。速战速决！",		-- 物品名:"天体英雄"->默认
			DEAD = "当心。",		-- 物品名:"天体英雄"->死了
		},
		ALTERGUARDIAN_PHASE2 = {
			GENERIC = "注意理智。",		-- 物品名:"天体英雄"->默认
			DEAD = "它还会卷土重来吗？",		-- 物品名:"天体英雄"->死了
		},
		ALTERGUARDIAN_PHASE2SPIKE = "远离！",		-- 物品名:"月光玻璃尖刺"
		ALTERGUARDIAN_PHASE3 = "这是最后的战斗了。",		-- 物品名:"天体英雄"
		ALTERGUARDIAN_PHASE3TRAP = "我讨厌那种感觉！",		-- 物品名:"启迪陷阱"
		ALTERGUARDIAN_PHASE3DEADORB = "它死了吗？那股神秘的力量好像还在它附近游荡。",		-- 物品名:"天体英雄"
		ALTERGUARDIAN_PHASE3DEAD = "应该。。结束了。",		-- 物品名:"被击败的天体英雄"

		ALTERGUARDIANHAT = "它让我看到了无限可能……",		-- 物品名:"启迪之冠"
		ALTERGUARDIANHATSHARD = "光彩夺目！",		-- 物品名:"启迪之冠碎片"
		...
		MOONSTORM_STATIC_ITEM = "似乎是和雷元素不同的闪电。",		-- 物品名:"约束静电"
		MOONSTORM_SPARK = "当心静电。",		-- 物品名:"月熠"

		BIRD_MUTANT = "我觉得那个以前应该是只乌鸦。",		-- 物品名:"月盲乌鸦"
		BIRD_MUTANT_SPITTER = "我不喜欢它盯着我的眼神……",		-- 物品名:"奇形鸟"

		WAGSTAFF_NPC = "想让他自己解决实验真是一种奢求。。",		-- 物品名:"颗粒状传输"

		WAGSTAFF_NPC_MUTATIONS = "速战速决吧。",	-- 物品名:"颗粒状传输"
		WAGSTAFF_NPC_WAGPUNK = "他去哪了？",	-- 物品名:"颗粒状传输"

		ALTERGUARDIAN_CONTAINED = "它正在耗尽那个怪物的能量！",		-- 物品名:"月亮精华提取器"

		WAGSTAFF_TOOL_1 = "网状缓冲器。",		-- 物品名:"网状缓冲器"
		WAGSTAFF_TOOL_2 = "装置除垢器。",		-- 物品名:"装置除垢器"
		WAGSTAFF_TOOL_3 = "垫圈开槽器。那些人都不看标签的吗？",		-- 物品名:"垫圈开槽器"
		WAGSTAFF_TOOL_4 = "概念刷洗器。奇怪的名字。",		-- 物品名:"概念刷洗器"
		WAGSTAFF_TOOL_5 = "校准观察机。快结束吧。",		-- 物品名:"校准观察机"

		MOONSTORM_GOGGLESHAT = "土豆的电力吗？真是神奇。",		-- 物品名:"天文护目镜" 制造描述:"利用土豆之眼来看清风暴。"

		MOON_DEVICE = {
			GENERIC = "它捕捉到能量了。",		-- 物品名:"月亮虹吸器"->默认
			CONSTRUCTION1 = "才刚刚开始。",		-- 物品名:"月亮虹吸器"->建造一阶段
			CONSTRUCTION2 = "快要完成了。",		-- 物品名:"月亮虹吸器"->建造二阶段
		},

		-- Wanda
		POCKETWATCH_HEAL = {
			GENERIC = "伊斯塔露？",		-- 物品名:"不老表"->默认 制造描述:"你觉得自己是几岁，你就是几岁。"
			RECHARGING = "这种力量也有局限。",		-- 物品名:"不老表"->冷却中 制造描述:"你觉得自己是几岁，你就是几岁。"
		},

		POCKETWATCH_REVIVE = {
			GENERIC = "伊斯塔露？",		-- 物品名:"第二次机会表"->默认 制造描述:"挽回一个朋友的不幸结局。"
			RECHARGING = "这种力量也有局限。",		-- 物品名:"第二次机会表"->冷却中 制造描述:"挽回一个朋友的不幸结局。"
		},

		POCKETWATCH_WARP = {
			GENERIC = "伊斯塔露？",		-- 物品名:"倒走表"->默认 制造描述:"重走你的最后几步。"
			RECHARGING = "这种力量也有局限。",		-- 物品名:"倒走表"->冷却中 制造描述:"重走你的最后几步。"
		},

		POCKETWATCH_RECALL = {
			GENERIC = "伊斯塔露？",		-- 物品名:"溯源表"->默认 制造描述:"返回到一个遥远的时间点。"
			RECHARGING = "这种力量也有局限。。",		-- 物品名:"溯源表"->冷却中 制造描述:"返回到一个遥远的时间点。"
		...
		POCKETWATCH_PORTAL = {
			GENERIC = "伊斯塔露？",		-- 物品名:"裂缝表"->默认 制造描述:"和朋友一起穿越时间会更好。"
			RECHARGING = "这种力量也有局限。。",		-- 物品名:"裂缝表"->冷却中 制造描述:"和朋友一起穿越时间会更好。"
		...
		POCKETWATCH_WEAPON = {
			GENERIC = "神奇而精妙的武器。",		-- 物品名:"警告表"->默认 制造描述:"这只钟敲的就是你。"
			DEPLETED = "only_used_by_wanda",		-- 物品名:"警告表"（旺达专用） 制造描述:"这只钟敲的就是你。"
		},

		POCKETWATCH_PARTS = "伊斯塔露？",		-- 物品名:"时间碎片" 制造描述:"计时必备零件。"
		POCKETWATCH_DISMANTLER = "沾染了时间的痕迹。",		-- 物品名:"钟表匠工具" 制造描述:"修补计时装置。"
		...
		-- The Terrorarium
		TERRARIUM = {
			GENERIC = "爱丽丝女士应该见过这个。",		-- 物品名:"泰拉瑞亚"->默认
			CRIMSON = "我有种不好的预感……",		-- 物品名:"泰拉瑞亚"->给予噩梦燃料
			ENABLED = "它在准备些什么。。",		-- 物品名:"泰拉瑞亚"->激活
			WAITING_FOR_DARK = "晚上要当心了。",		-- 物品名:"泰拉瑞亚"->等待夜晚
			COOLDOWN = "这之后需要冷却一下。",		-- 物品名:"泰拉瑞亚"->冷却中
			SPAWN_DISABLED = "？",		-- 物品名:"泰拉瑞亚"->无法召唤
		},

		-- Wolfgang
		MIGHTY_GYM = 
		{
			GENERIC = "不错的锻炼方式。",	-- 物品名:"强大健身房"->默认
			BURNT = "好可惜。",		-- 物品名:"强大健身房"->烧焦了
		},

		DUMBBELL = "我做脑力训练比较多。",		-- 物品名:"哑铃"
		DUMBBELL_GOLDEN = "精诚所至，金石为开。",		-- 物品名:"黄金哑铃"
		DUMBBELL_MARBLE = "我已经把我的大脑锻炼成了我身上最强壮的肌肉。",	-- 物品名:"大理石哑铃"
		DUMBBELL_GEM = "这点重量，我轻松就能征服。",		-- 物品名:"宝石哑铃"
		...
		VEGGIEOMLET = "早餐是一天中最重要的一餐。",	-- 物品名:"早餐铁锅"
		TALLEGGS = "早餐技术的突破！",	-- 物品名:"高大苏格兰蛋"
		BEEFALOFEED = "我不要，谢谢你。",	-- 物品名:"蒸树枝"
		BEEFALOTREAT = "有些粗糙。",	-- 物品名:"皮弗娄牛零食"
		...
		BOAT_MAGNET =
		{
			GENERIC = "希望不会出岔子。",	-- 物品名:"自动航行"->默认
			ACTIVATED = "奏效了！！呃，我当然一早就知道它能行。",	-- 物品名:"自动航行"->已激活
		},
		BOAT_MAGNET_KIT = "效率提升了。",	-- 物品名:"自动航行套装"
		...
		MONKEYHUT =
		{
			GENERIC = "拆了它！",	-- 物品名:"猴子小屋"->默认
			BURNT = "好多了。",	-- 物品名:"猴子小屋"->烧毁
		},
		POWDER_MONKEY = "小心诅咒。",	-- 物品名:"火药猴"
		PRIME_MATE = "一顶漂亮的帽子总能清楚地表明谁是老大。",	-- 物品名:"大副"
		LIGHTCRAB = "它是发光生物！",	-- 物品名:"发光蟹"
		CUTLESS = "盗窃的工具。",	-- 物品名:"木头短剑"
		CURSED_MONKEY_TOKEN = "远离。",	-- 物品名:"诅咒饰品"
		...
		PALMCONE_SCALE = "坚固。",	-- 物品名:"棕榈松果树鳞片"
		MONKEYTAIL = "真是偷懒啊。",	-- 物品名:"猴尾草"
		DUG_MONKEYTAIL = "真是偷懒啊。",	-- 物品名:"猴尾草"
		...
		MONKEYISLAND_PORTAL_DEBRIS = "奇怪的机械。",	-- 物品名:"损坏的机器"
		MONKEYQUEEN = "这片儿看起来是她说了算。",	-- 物品名:"月亮码头女王"
		MONKEYPILLAR = "名副其实的社会栋梁。",	-- 物品名:"猴子柱"
		PIRATE_FLAG_POLE = "喂！",	-- 物品名:"月亮码头海盗旗"

		BLACKFLAG = "海盗都喜欢这种风格吗？",	-- 物品名:"黑旗"
		PIRATE_STASH = "我不喜欢这个装饰。",	-- 物品名:"X"
		...
		HORRORFUEL = "存粹的深渊能量。",	-- 物品名:"纯粹恐惧" 制造描述:"化绝望石为纯粹恐惧。"
		DAYWALKER =
		{
			GENERIC = "注意迎敌！",	-- 物品名:"噩梦猪人"->被释放
			IMPRISONED = "风险与机遇并存。",	-- 物品名:"噩梦猪人"->被锁住
		},
		DAYWALKER_PILLAR =
		{
		...
		DREADSTONEHAT = "安全，但是对理智不太友好。",	-- 物品名:"绝望石头盔" 制造描述:"由至黑的石头做成的结实头盔。"

		-- Rifts 1
		LUNARRIFT_PORTAL = "小心！深渊的力量正在涌出！",	-- 物品名:"裂隙"
		LUNARRIFT_CRYSTAL = "发光体结晶。",	-- 物品名:"裂隙晶体"

		LUNARTHRALL_PLANT = "小心它的刺。",	-- 物品名:"致命亮茄"
		LUNARTHRALL_PLANT_VINE_END = "它有着带刺的外观。",	-- 物品名:"钻地藤蔓"

		LUNAR_GRAZER = "它一定是通过那个奇怪的裂隙来的。",	-- 物品名:"牧者"

		PUREBRILLIANCE = "至纯的天空能量。",	-- 物品名:"纯粹辉煌"
		LUNARPLANT_HUSK = "出奇的坚硬。",	-- 物品名:"亮茄外壳"

		LUNAR_FORGE = "可以做一些更有用的东西。",	-- 物品名:"辉煌铁匠铺"
		LUNAR_FORGE_KIT = "简单的元素组合！",	-- 物品名:"辉煌铁匠铺套装" 制造描述:"锻造异世界的物品。"

		LUNARPLANT_KIT = "可以修补一些装备。",	-- 物品名:"亮茄修补套件" 制造描述:"修复损坏的设备。"
		...
		PUNCHINGBAG = "练手的好东西。",	-- 物品名:"拳击袋" 制造描述:"测试武器的强度。并从中获得乐趣！"

		-- Rifts 2
		SHADOWRIFT_PORTAL = "那东西看起来像是会一直持续下去。",	-- 物品名:"裂隙"

		SHADOW_FORGE = "它会为哪些黑暗设计带来生命呢？",	-- 物品名:"暗影术基座"
		SHADOW_FORGE_KIT = "危险，但诱人。",	-- 物品名:"暗影术基座套装" 制造描述:"让恐惧为你所用。"
		...
		VOIDCLOTH_UMBRELLA = "终于有办法对付酸雨了。",	-- 物品名:"暗影伞" 制造描述:"暗影提供的保护，不惧最严峻的降雨。"
		VOIDCLOTH_SCYTHE = "大为简化了收割流程。",	-- 物品名:"暗影收割者" 制造描述:"从容地剔除植物群落。"

		SHADOWTHRALL_HANDS = "甘！",	-- 物品名:"墨荒"->躁动
		SHADOWTHRALL_HORNS = "文！",	-- 物品名:"墨荒"->刮擦
		SHADOWTHRALL_WINGS = "崔！",	-- 物品名:"墨荒"->尖叫

		CHARLIE_NPC = "查理？",	-- 物品名:"查理"
		CHARLIE_HAND = "V它五石。",	-- 物品名:"召唤之手"
		...
		MUTATEDDEERCLOPS = "善用火攻。",	-- 物品名:"晶体独眼巨鹿"
		MUTATEDWARG = "它在进攻的时候更为脆弱。",	-- 物品名:"附身座狼"
		MUTATEDBEARGER = "当心它的重量。。",	-- 物品名:"装甲熊獾"

		LUNARFROG = "真烦人。",	-- 物品名:"明眼青蛙"
		...
		{
			GENERIC = "这就叫冰冷的目光吧？",	-- Enabled.	-- 物品名:"冰眼结晶器"->有眼珠
			NOEYEBALL = "是谁丢了一只眼睛呢？",  -- Disabled.	-- 物品名:"冰眼结晶器"->无眼珠
		},
		DEERCLOPSEYEBALL_SENTRYWARD_KIT = "浓缩的冰元素。",	-- 物品名:"冰眼结晶器套装" 制造描述:"用冻伤来治疗一下晒伤。"

		SECURITY_PULSE_CAGE = "有趣。它是空的。",	-- 物品名:"火花柜"
		SECURITY_PULSE_CAGE_FULL = "装满了。",	-- 物品名:"火花柜"
		...
		WOOD_CHAIR =
		{
			...
			OCCUPIED = "能坐，事3A。",	-- 物品名:"木椅"->有人 制造描述:"一把可以坐的木椅。"
		...
		DECOR_FLOWERVASE =
		{
			...
			OLDLIGHT = "记得换灯泡的。",	-- 物品名:"餐桌花瓶"->有发光物品且已腐败 制造描述:"这是一个放置鲜切花的好地方。"
		},
		DECOR_PICTUREFRAME =
		{
		...
		WAGPUNKHAT = "神奇的机械装置。",	-- 物品名:"W.A.R.B.I.S.头戴齿轮" 制造描述:"看起来聪明，打起来也聪明。"
		ARMORWAGPUNK = "令人敬畏的齿轮。",	-- 物品名:"W.A.R.B.I.S.盔甲" 制造描述:"开足马力，全速前进！"
		WAGSTAFF_MACHINERY = "在这堆垃圾中也许会有所发现。",	-- 物品名:"被丢弃的垃圾"
		WAGPUNK_BITS = "残破，但有用。",	-- 物品名:"废铁"
		WAGPUNKBITS_KIT = "机器修理别的机器！科学接下来还会想出什么？",	-- 物品名:"自动修理机" 制造描述:"你得心应手的W.A.R.B.I.S.维修工具！"

		WAGSTAFF_MUTATIONS_NOTE = "有些难懂。。",	-- 物品名:"研究笔记"

		-- Meta 3

		BATTLESONG_INSTANT_REVIVE = "这首曲子太有生命力了。",	--物品名:"战士重奏"

		WATHGRITHR_IMPROVEDHAT = "薇格弗德有领导经验吗？又让她如虎添翼了？",	--物品名:"统帅头盔"
		SPEAR_WATHGRITHR_LIGHTNING = "它得到了电流的加强。",	--物品名:"奔雷矛"

		BATTLESONG_CONTAINER = "哇，它能存这么多歌。",	--物品名:"战斗号子罐"

		SADDLE_WATHGRITHR = "那是薇格弗德做的？这个让她猛虎插翅。",	--物品名:"战斗鞍具"

		WATHGRITHR_SHIELD = "保护我！！",	--物品名:"战斗圆盾"

		BATTLESONG_SHADOWALIGNED = "戏剧让我坐立不安。",	--物品名:"黑暗悲歌"
		BATTLESONG_LUNARALIGNED = "戏剧让我坐立不安。",	--物品名:"启迪摇篮曲"

		SHARKBOI = "鱼你太美。",	--物品名:"大霜鲨"
		...
		["KQ_GOLDENSHRIMP"] =
		{
			GENERIC = "｡＾･؂･＾｡",-- 特定人物的物体的检查描述，但是因为bug不生效
		},
	},

	DESCRIBE_GENERIC = "谁忘了写检查语言了？",		--检查物品描述的缺省值
