...
local actions_status, actions_data = pcall(require, "defs/actions")
print("actions_status", actions_status)
if not actions_status then
	print("actions_data load failed")
...
if actions_status then
	...
	dumptable(actions_data.actions)
	-- 导入动作与组件的绑定
	...
	dumptable(actions_data.component_actions)
	-- 修改老动作
