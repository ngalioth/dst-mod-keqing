...
{
	"character", "keqing", "genshin impact",
}

local keys = {"B","C","E","F","G","H","I","J","K","L","N","O","Q","R","T","V","X","Z","LAlt","RAlt","LCtrl","RCtrl","LShift","RShift","LALT","RALT","1","2","3","4","5","6","7","8","9","0"}
local list = {}
local string = ""
for i = 1, #keys do
